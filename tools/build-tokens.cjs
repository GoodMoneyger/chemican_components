...
fs.readFile(inputFile, 'utf8', (err, data) => {
  ...
  let tsResult = `// This file is generated from the source tokens file coming from Figma.\n`;
      ...
      ([themeName, tokens]) => {
        Object.keys(tokens)
          ...
          .forEach((token) => {
            ...
            tsResult += `  ${tokenName} = '${token.slice(2)}',\n`;
          });
      }
    );
    tsResult += `}\n\n`;
  ...
  tsResult += `  'Primitives': ThemeTokens;\n`;
  tsResult += `}\n\n`;
