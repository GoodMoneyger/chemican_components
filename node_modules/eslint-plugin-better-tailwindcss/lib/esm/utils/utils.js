...
export function augmentMessageWithWarnings(message, documentationUrl, warnings) {
...
export function getExactClassLocation(literal, className, partial = false, lastIndex = false) {
