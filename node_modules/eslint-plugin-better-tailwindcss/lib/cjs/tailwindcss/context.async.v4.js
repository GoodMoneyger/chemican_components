...
const createTailwindContext = async (entryPoint) => (0, cache_js_1.withCache)(entryPoint, async () => {
    ...
    const tailwindPath = ((0, module_js_1.isESModule)()
        ? resolvers_js_1.esmResolver
