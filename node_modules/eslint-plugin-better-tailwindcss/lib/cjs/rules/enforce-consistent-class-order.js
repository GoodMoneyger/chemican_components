...
const class_variants_js_1 = require("../tailwindcss/class-variants.js");
...
function sortClassNames(ctx, classes) {
    ...
    const { classVariants } = (0, class_variants_js_1.getClassVariants)({ classes, configPath: tailwindConfig, cwd: ctx.cwd });
