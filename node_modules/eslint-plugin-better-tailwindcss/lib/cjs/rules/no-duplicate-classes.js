...
function lintLiterals(ctx, literals) {
    for (const literal of literals) {
        ...
        const escapedClasses = (0, quotes_js_1.escapeNestedQuotes)(finalChunks.join(""), literal.openingQuote ?? literal.closingQuote ?? "\"");
        const fixedClasses = [
        ...
        for (const className of duplicates) {
            ctx.report({
                ...
                loc: (0, utils_js_1.getExactClassLocation)(literal, className, false, true),
