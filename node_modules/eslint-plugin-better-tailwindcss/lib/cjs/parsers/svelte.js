...
function getLiteralsBySvelteAttribute(ctx, attribute, attributes) {
    ...
    const literals = attributes.reduce((literals, attributes) => {
        if ((0, matchers_js_1.isAttributesName)(attributes)) {
            if (!(0, utils_js_1.matchesName)(attributes.toLowerCase(), attribute.key.name.toLowerCase())) {
                return literals;
            }
            ...
            if (!(0, utils_js_1.matchesName)(attributes[0].toLowerCase(), attribute.key.name.toLowerCase())) {
                return literals;
            }
