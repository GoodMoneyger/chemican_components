...
), Tf = S.forwardRef(({ className: e, label: t, orientation: n, children: r, ...o }, a) => /* @__PURE__ */ c.jsxs(
  "div",
  {
    ref: a,
    className: D(IC({ orientation: n }), e),
    ...o,
    children: [
      /* @__PURE__ */ c.jsx("div", { className: D(LC({ orientation: n })), children: t }),
      /* @__PURE__ */ c.jsx("div", { className: D($C({ orientation: n })), children: r })
    ]
  }
));
