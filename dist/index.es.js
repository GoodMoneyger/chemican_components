...
import N, { useState as cn, useLayoutEffect as Si, forwardRef as wf, createElement as Co, createContext as xa, useContext as ba, useCallback as Me, useRef as _n, useEffect as ki, useMemo as So } from "react";
...
var ps;
function Mf() {
  return ps || (ps = 1, process.env.NODE_ENV === "production" ? cr.exports = Sf() : cr.exports = kf()), cr.exports;
}
var c = Mf();
function Mi(e) {
  var t, n, r = "";
  if (typeof e == "string" || typeof e == "number") r += e;
    ...
    var o = e.length;
    for (t = 0; t < o; t++) e[t] && (n = Mi(e[t])) && (r && (r += " "), r += n);
  } else for (n in e) e[n] && (r && (r += " "), r += n);
  return r;
}
function Ni() {
  for (var e, t, n = 0, r = "", o = arguments.length; n < o; n++) (e = arguments[n]) && (t = Mi(e)) && (r && (r += " "), r += t);
  return r;
}
const hs = (e) => typeof e == "boolean" ? `${e}` : e === 0 ? "0" : e, vs = Ni, ae = (e, t) => (n) => {
  var r;
  if ((t == null ? void 0 : t.variants) == null) return vs(e, n == null ? void 0 : n.class, n == null ? void 0 : n.className);
  ...
  return vs(e, s, l, n == null ? void 0 : n.class, n == null ? void 0 : n.className);
};
function gs(e, t) {
...
// @__NO_SIDE_EFFECTS__
function Mt(e) {
  const t = /* @__PURE__ */ Nf(e), n = u.forwardRef((r, o) => {
    const { children: a, ...s } = r, i = u.Children.toArray(a), l = i.find(Pf);
    if (l) {
...
function Pf(e) {
  return u.isValidElement(e) && typeof e.type == "function" && "__radixId" in e.type && e.type.__radixId === Ei;
}
function Rf(e, t) {
  const n = { ...t };
  for (const r in t) {
...
var Pi = Object.freeze({
  ...
  whiteSpace: "nowrap",
  wordWrap: "normal"
}), Of = "VisuallyHidden", Vr = u.forwardRef(
  (e, t) => /* @__PURE__ */ c.jsx(
    Q.span,
    {
      ...e,
...
}, Tf = u[" useInsertionEffect ".trim().toString()] || Re;
function Ke({
  prop: e,
  defaultProp: t,
  onChange: n = () => {
...
var Oe = (e) => {
  const { present: t, children: n } = e, r = $f(t), o = typeof n == "function" ? n({ present: r.isPresent }) : u.Children.only(n), a = ce(r.ref, Vf(o));
  return typeof n == "function" || r.isPresent ? u.cloneElement(o, { ref: a }) : null;
};
Oe.displayName = "Presence";
function $f(e) {
  const [t, n] = u.useState(), r = u.useRef(null), o = u.useRef(e), a = u.useRef("none"), s = e ? "mounted" : "unmounted", [i, l] = Ff(s, {
    mounted: {
      UNMOUNT: "unmounted",
...
var Bf = u[" useId ".trim().toString()] || (() => {
}), zf = 0;
function Ne(e) {
  const [t, n] = u.useState(Bf());
  return Re(() => {
    n((r) => r ?? String(zf++));
  }, [e]), e || (t ? `radix-${t}` : "");
}
...
function Yf(e, t = globalThis == null ? void 0 : globalThis.document) {
  const n = Le(e);
  u.useEffect(() => {
    const r = (o) => {
      o.key === "Escape" && n(o);
...
var Gf = "DismissableLayer", Uo = "dismissableLayer.update", Uf = "dismissableLayer.pointerDownOutside", Kf = "dismissableLayer.focusOutside", xs, Ri = u.createContext({
  ...
  (e, t) => {
    const {
      ...
      onDismiss: i,
      ...l
    } = e, d = u.useContext(Ri), [f, m] = u.useState(null), p = (f == null ? void 0 : f.ownerDocument) ?? (globalThis == null ? void 0 : globalThis.document), [, v] = u.useState({}), x = ce(t, (S) => m(S)), h = Array.from(d.layers), [g] = [...d.layersWithOutsidePointerEventsDisabled].slice(-1), y = h.indexOf(g), b = f ? h.indexOf(f) : -1, w = d.layersWithOutsidePointerEventsDisabled.size > 0, k = b >= y, C = Xf((S) => {
    ...
    return Yf((S) => {
      ...
      if (f)
        return n && (d.layersWithOutsidePointerEventsDisabled.size === 0 && (xs = p.body.style.pointerEvents, p.body.style.pointerEvents = "none"), d.layersWithOutsidePointerEventsDisabled.add(f)), d.layers.add(f), bs(), () => {
          n && d.layersWithOutsidePointerEventsDisabled.size === 1 && (p.body.style.pointerEvents = xs);
        };
    }, [f, p, n, d]), u.useEffect(() => () => {
...
var qf = "DismissableLayerBranch", Di = u.forwardRef((e, t) => {
  const n = u.useContext(Ri), r = u.useRef(null), o = ce(t, r);
  return u.useEffect(() => {
    const a = r.current;
    if (a)
...
function Zf(e, t = globalThis == null ? void 0 : globalThis.document) {
  ...
  return u.useEffect(() => {
    const o = (a) => {
      a.target && !r.current && Ai(Kf, n, { originalEvent: a }, {
        discrete: !1
      });
    };
...
var Qf = zt, Jf = Di, ko = "focusScope.autoFocusOnMount", Mo = "focusScope.autoFocusOnUnmount", ys = { bubbles: !1, cancelable: !0 }, em = "FocusScope", zn = u.forwardRef((e, t) => {
  const {
    loop: n = !1,
    trapped: r = !1,
    onMountAutoFocus: o,
    ...
    ...s
  } = e, [i, l] = u.useState(null), d = Le(o), f = Le(a), m = u.useRef(null), p = ce(t, (h) => l(h)), v = u.useRef({
    paused: !1,
    pause() {
      this.paused = !0;
    },
  ...
  u.useEffect(() => {
    ...
    if (i) {
      ...
      if (!i.contains(h)) {
        const y = new CustomEvent(ko, ys);
        i.addEventListener(ko, d), i.dispatchEvent(y), y.defaultPrevented || (tm(sm(Oi(i)), { select: !0 }), document.activeElement === h && St(i));
      }
      return () => {
        i.removeEventListener(ko, d), setTimeout(() => {
          const y = new CustomEvent(Mo, ys);
          i.addEventListener(Mo, f), i.dispatchEvent(y), y.defaultPrevented || St(h ?? document.body, { select: !0 }), i.removeEventListener(Mo, f), Cs.remove(v);
        }, 0);
      };
    }
  }, [i, d, f, v]);
  const x = u.useCallback(
    (h) => {
      ...
      if (g && y) {
        const b = h.currentTarget, [w, k] = nm(b);
...
function nm(e) {
  const t = Oi(e), n = ws(t, e), r = ws(t.reverse(), e);
  return [n, r];
}
function Oi(e) {
...
function am() {
  ...
  return {
    add(t) {
      const n = e[0];
      t !== n && (n == null || n.pause()), e = Ss(e, t), e.unshift(t);
    },
    remove(t) {
      var n;
      e = Ss(e, t), (n = e[0]) == null || n.resume();
    }
  };
}
function Ss(e, t) {
...
function zr() {
  u.useEffect(() => {
    ...
    return document.body.insertAdjacentElement("afterbegin", e[0] ?? ks()), document.body.insertAdjacentElement("beforeend", e[1] ?? ks()), No++, () => {
...
var Sr = "right-scroll-bar-position", kr = "width-before-scroll-bar", lm = "with-scroll-bars-hidden", dm = "--removed-body-scroll-bar-size";
function Eo(e, t) {
...
var fm = typeof window < "u" ? u.useLayoutEffect : u.useEffect, Ms = /* @__PURE__ */ new WeakMap();
function mm(e, t) {
...
var ji = vm(), Po = function() {
}, Hr = u.forwardRef(function(e, t) {
  var n = u.useRef(null), r = u.useState({
    onScrollCapture: Po,
    onWheelCapture: Po,
    onTouchMoveCapture: Po
  }), o = r[0], a = r[1], s = e.forwardProps, i = e.children, l = e.className, d = e.removeScrollBar, f = e.enabled, m = e.shards, p = e.sideCar, v = e.noRelative, x = e.noIsolation, h = e.inert, g = e.allowPinchZoom, y = e.as, b = y === void 0 ? "div" : y, w = e.gapMode, k = _i(e, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noRelative", "noIsolation", "inert", "allowPinchZoom", "as", "gapMode"]), C = p, M = mm([n, t]), S = at(at({}, k), o);
  return u.createElement(
    u.Fragment,
    null,
    f && u.createElement(C, { sideCar: ji, removeScrollBar: d, shards: m, noRelative: v, noIsolation: x, inert: h, setCallbacks: a, allowPinchZoom: !!g, lockRef: n, gapMode: w }),
...
}, Em = Ti(), on = "data-scroll-locked", Pm = function(e, t, n, r) {
...
`);
  ...
  u.useEffect(function() {
    return document.body.setAttribute(on, (Ns() + 1).toString()), function() {
      var e = Ns() - 1;
  ...
  return u.createElement(Em, { styles: Pm(a, !t, o, n ? "" : "!important") });
}, Ko = !1;
if (typeof window < "u")
  try {
...
var Zt = Ko ? { passive: !1 } : !1, Am = function(e) {
  ...
  return (
    ...
    !(n.overflowY === n.overflowX && !Am(e) && n[t] === "visible")
  );
}, Om = function(e) {
  ...
  return e === "v" ? Om(t) : _m(t);
}, Fi = function(e, t) {
  return e === "v" ? Im(t) : jm(t);
}, Tm = function(e, t) {
  return e === "h" && t === "rtl" ? -1 : 1;
}, Wm = function(e, t, n, r, o) {
  var a = Tm(e, window.getComputedStyle(t).direction), s = a * r, i = n.target, l = t.contains(i), d = !1, f = s > 0, m = 0, p = 0;
  do {
    if (!i)
      break;
    var v = Fi(e, i), x = v[0], h = v[1], g = v[2], y = h - g - a * x;
    (x || y) && Li(e, i) && (m += y, p += x);
    var b = i.parentNode;
...
function Vm(e) {
  var t = u.useRef([]), n = u.useRef([0, 0]), r = u.useRef(), o = u.useState($m++)[0], a = u.useState(Ti)[0], s = u.useRef(e);
  u.useEffect(function() {
    s.current = e;
  }, [e]), u.useEffect(function() {
    if (e.inert) {
      document.body.classList.add("block-interactivity-".concat(o));
      var h = cm([e.lockRef.current], (e.shards || []).map(Rs), !0).filter(Boolean);
  ...
  var i = u.useCallback(function(h, g) {
    ...
    if (!(!Qt.length || Qt[Qt.length - 1] !== a)) {
      var y = "deltaY" in g ? Ps(g) : ur(g), b = t.current.filter(function(C) {
        return C.name === g.type && (C.target === g.target || g.target === C.shadowParent) && Lm(C.delta, y);
      })[0];
      if (b && b.should) {
      ...
      if (!b) {
        var w = (s.current.shards || []).map(Rs).filter(Boolean).filter(function(C) {
    ...
    var w = { name: h, delta: g, target: y, should: b, shadowParent: Bm(y) };
    ...
    d(h.type, Ps(h), h.target, i(h, e.lockRef.current));
...
var Hn = u.forwardRef(function(e, t) {
  return u.createElement(Hr, at({}, e, { ref: t, sideCar: zm }));
});
...
var Hm = function(e) {
...
}, Jt = /* @__PURE__ */ new WeakMap(), fr = /* @__PURE__ */ new WeakMap(), mr = {}, Do = 0, $i = function(e) {
  ...
  var o = Ym(t, Array.isArray(e) ? e : [e]);
...
}, Gr = "Dialog", [Vi] = Ae(Gr), [Um, tt] = Vi(Gr), Bi = (e) => {
  const {
    __scopeDialog: t,
    children: n,
    open: r,
...
Bi.displayName = Gr;
var zi = "DialogTrigger", Km = u.forwardRef(
  (e, t) => {
    const { __scopeDialog: n, ...r } = e, o = tt(zi, n), a = ce(t, o.triggerRef);
    return /* @__PURE__ */ c.jsx(
      Q.button,
      {
        type: "button",
...
Km.displayName = zi;
var wa = "DialogPortal", [qm, Hi] = Vi(wa, {
  forceMount: void 0
}), Yi = (e) => {
...
Yi.displayName = wa;
var Dr = "DialogOverlay", Gi = u.forwardRef(
  (e, t) => {
    const n = Hi(Dr, e.__scopeDialog), { forceMount: r = n.forceMount, ...o } = e, a = tt(Dr, e.__scopeDialog);
    return a.modal ? /* @__PURE__ */ c.jsx(Oe, { present: r || a.open, children: /* @__PURE__ */ c.jsx(Zm, { ...o, ref: t }) }) : null;
  }
);
Gi.displayName = Dr;
var Xm = /* @__PURE__ */ Mt("DialogOverlay.RemoveScroll"), Zm = u.forwardRef(
  (e, t) => {
    const { __scopeDialog: n, ...r } = e, o = tt(Dr, n);
    return (
      // Make sure `Content` is scrollable even when it doesn't live inside `RemoveScroll`
      // ie. when `Overlay` and `Content` are siblings
      /* @__PURE__ */ c.jsx(Hn, { as: Xm, allowPinchZoom: !0, shards: [o.contentRef], children: /* @__PURE__ */ c.jsx(
        Q.div,
        {
          "data-state": Sa(o.open),
          ...r,
...
), Lt = "DialogContent", Ui = u.forwardRef(
  (e, t) => {
    const n = Hi(Lt, e.__scopeDialog), { forceMount: r = n.forceMount, ...o } = e, a = tt(Lt, e.__scopeDialog);
    return /* @__PURE__ */ c.jsx(Oe, { present: r || a.open, children: a.modal ? /* @__PURE__ */ c.jsx(Qm, { ...o, ref: t }) : /* @__PURE__ */ c.jsx(Jm, { ...o, ref: t }) });
  }
);
Ui.displayName = Lt;
var Qm = u.forwardRef(
  ...
  (e, t) => {
    ...
    return zr(), /* @__PURE__ */ c.jsxs(c.Fragment, { children: [
      ...
      /* @__PURE__ */ c.jsxs(c.Fragment, { children: [
        /* @__PURE__ */ c.jsx(tp, { titleId: i.titleId }),
        /* @__PURE__ */ c.jsx(rp, { contentRef: l, descriptionId: i.descriptionId })
      ] })
    ] });
  }
), Ca = "DialogTitle", qi = u.forwardRef(
  (e, t) => {
...
qi.displayName = Ca;
var Xi = "DialogDescription", ep = u.forwardRef(
  (e, t) => {
    const { __scopeDialog: n, ...r } = e, o = tt(Xi, n);
    return /* @__PURE__ */ c.jsx(Q.p, { id: o.descriptionId, ...r, ref: t });
  }
);
ep.displayName = Xi;
var Zi = "DialogClose", Qi = u.forwardRef(
  (e, t) => {
...
var Ji = "DialogTitleWarning", [dS, ec] = If(Ji, {
  contentName: Lt,
  titleName: Ca,
  docsSlug: "dialog"
}), tp = ({ titleId: e }) => {
  const t = ec(Ji), n = `\`${t.contentName}\` requires a \`${t.titleName}\` for the component to be accessible for screen reader users.
...
}, np = "DialogDescriptionWarning", rp = ({ contentRef: e, descriptionId: t }) => {
  const r = `Warning: Missing \`Description\` or \`aria-describedby={undefined}\` for {${ec(np).contentName}}.`;
  return u.useEffect(() => {
    var a;
    const o = (a = e.current) == null ? void 0 : a.getAttribute("aria-describedby");
    t && o && (document.getElementById(t) || console.warn(r));
  }, [r, e, t]), null;
}, ka = Bi, tc = Yi, Ma = Gi, Na = Ui, nc = qi, Ea = Qi;
function Ur(e) {
...
const cp = ["top", "right", "bottom", "left"], Nt = Math.min, Be = Math.max, Ar = Math.round, pr = Math.floor, dt = (e) => ({
  x: e,
  y: e
}), lp = {
  left: "right",
...
const Ds = ["left", "right"], As = ["right", "left"], pp = ["top", "bottom"], hp = ["bottom", "top"];
function vp(e, t, n) {
  switch (e) {
    case "top":
    case "bottom":
      return n ? t ? As : Ds : t ? Ds : As;
    case "left":
    case "right":
      return t ? pp : hp;
    default:
...
function jn(e, t, n) {
  ...
  const o = pc(e), a = o === ((r = e.ownerDocument) == null ? void 0 : r.body), s = ze(o);
  if (a) {
    const i = Zo(s);
...
const eh = kp, th = Mp, nh = wp, rh = Ep, oh = Cp, Fs = yp, ah = Np, sh = (e, t, n) => {
...
function lh(e) {
  ...
  const Y = u.useMemo(() => ({
    ...
    if (!$.floating)
      return D;
    const W = $s($.floating, f.x), R = $s($.floating, f.y);
    return i ? {
      ...D,
...
var Ah = u.forwardRef((e, t) => {
  const {
    ...
    onChange: l,
    caller: Un
  }), [y, b] = u.useState(!1), w = Le(d), k = Oc(n), C = u.useRef(!1), [M, S] = u.useState(0);
  return u.useEffect(() => {
    const P = p.current;
    if (P)
...
var Wa = _c, La = jc, Jo = ["Enter", " "], Th = ["ArrowDown", "PageUp", "Home"], Wc = ["ArrowUp", "PageDown", "End"], Wh = [...Th, ...Wc], Lh = {
  ...
  const { __scopeMenu: t, open: n = !1, children: r, dir: o, onOpenChange: a, modal: s = !0 } = e, i = ro(t), [l, d] = u.useState(null), f = u.useRef(!1), m = Le(a), p = Bn(o);
  return u.useEffect(() => {
    const v = () => {
...
Bc.displayName = $a;
var Ue = "MenuContent", [Gh, Va] = Yt(Ue), zc = u.forwardRef(
  (e, t) => {
    const n = Vc(Ue, e.__scopeMenu), { forceMount: r = n.forceMount, ...o } = e, a = Gt(Ue, e.__scopeMenu), s = qn(Ue, e.__scopeMenu);
  ...
  (e, t) => {
    const {
      ...
      ...h
    } = e, g = Gt(Ue, n), y = qn(Ue, n), b = ro(n), w = Fc(n), k = $h(n), [C, M] = u.useState(null), S = u.useRef(null), P = ce(t, S, g.onContentChange), F = u.useRef(0), z = u.useRef(""), U = u.useRef(0), B = u.useRef(null), X = u.useRef("right"), j = u.useRef(0), Y = x ? Hn : u.Fragment, $ = x ? { as: qh, allowPinchZoom: !0 } : void 0, K = (W) => {
      var O, q;
...
Hc.displayName = Zh;
var jr = "MenuItem", Vs = "menu.itemSelect", oo = u.forwardRef(
  (e, t) => {
    const { disabled: n = !1, onSelect: r, ...o } = e, a = u.useRef(null), s = qn(jr, e.__scopeMenu), i = Va(jr, e.__scopeMenu), l = ce(t, a), d = u.useRef(!1), f = () => {
      const m = a.current;
      if (!n && m) {
        const p = new CustomEvent(Vs, { bubbles: !0, cancelable: !0 });
        m.addEventListener(Vs, (v) => r == null ? void 0 : r(v), { once: !0 }), ya(m, p), p.defaultPrevented ? d.current = !1 : s.onClose();
      }
    };
    return /* @__PURE__ */ c.jsx(
      Yc,
...
var rl = "MenuSubContent", ol = u.forwardRef(
  (e, t) => {
    const n = Vc(Ue, e.__scopeMenu), { forceMount: r = n.forceMount, ...o } = e, a = Gt(Ue, e.__scopeMenu), s = qn(Ue, e.__scopeMenu), i = tl(rl, e.__scopeMenu), l = u.useRef(null), d = ce(t, l);
...
var Nl = gl, El = yl, Pl = wl, Ua = Cl, Ka = "Progress", qa = 100, [dg] = Ae(Ka), [ug, fg] = dg(Ka), Rl = u.forwardRef(
  (e, t) => {
    ...
    (o || o === 0) && !zs(o) && console.error(pg(`${o}`, "Progress"));
    const i = zs(o) ? o : qa;
    r !== null && !Hs(r, i) && console.error(hg(`${r}`, "Progress"));
    const l = Hs(r, i) ? r : null, d = Wr(l) ? a(l, i) : void 0;
...
var $g = "SelectItemAlignedPosition", td = u.forwardRef((e, t) => {
  const { __scopeSelect: n, onPlaced: r, ...o } = e, a = At(Vt, n), s = Ot(Vt, n), [i, l] = u.useState(null), [d, f] = u.useState(null), m = ce(t, (S) => f(S)), p = lo(n), v = u.useRef(!1), x = u.useRef(!0), { viewport: h, selectedItem: g, selectedItemText: y, focusSelectedItem: b } = s, w = u.useCallback(() => {
    if (a.trigger && a.valueNode && i && d && h && g && y) {
      ...
      if (a.dir !== "rtl") {
        const ie = z.left - P.left, ue = F.left - ie, ke = S.left - ue, _e = S.width + ke, nt = Math.max(_e, P.width), Xe = window.innerWidth - Ze, rt = Bs(ue, [
          Ze,
        ...
        const ie = P.right - z.right, ue = window.innerWidth - F.right - ie, ke = window.innerWidth - S.right - ue, _e = S.width + ke, nt = Math.max(_e, P.width), Xe = window.innerWidth - Ze, rt = Bs(ue, [
          Ze,
          Math.max(Ze, Xe - nt)
        ]);
...
var [A0, O0] = jd(Zn, {
  ...
  (e, t) => {
    const {
      ...
      onSwipeEnd: v,
      ...x
    } = e, h = po(Zn, n), [g, y] = u.useState(null), b = ce(t, (j) => y(j)), w = u.useRef(null), k = u.useRef(null), C = o || h.duration, M = u.useRef(0), S = u.useRef(C), P = u.useRef(0), { onToastAdd: F, onToastRemove: z } = h, U = Le(() => {
      var Y;
              ...
              Q.li,
              {
                ...
                onPointerMove: V(e.onPointerMove, (j) => {
                  ...
                  K ? (k.current = _, hr(P0, m, I, {
                    discrete: !1
                  })) : Ys(_, h.swipeDirection, E) ? (k.current = _, hr(E0, f, I, {
                    discrete: !1
                ...
                onPointerUp: V(e.onPointerUp, (j) => {
                  ...
                  if ($.hasPointerCapture(j.pointerId) && $.releasePointerCapture(j.pointerId), k.current = null, w.current = null, Y) {
                    ...
                    Ys(Y, h.swipeDirection, h.swipeThreshold) ? hr(D0, v, D, {
                      discrete: !0
                    }) : hr(
                      R0,
                      p,
...
var Ln = "Tooltip", [K0, Qn] = ho(Ln), Zd = (e) => {
  const {
    ...
    delayDuration: i
  } = e, l = ts(Ln, e.__scopeTooltip), d = vo(t), [f, m] = u.useState(null), p = Ne(), v = u.useRef(0), x = s ?? l.disableHoverableContent, h = i ?? l.delayDuration, g = u.useRef(!1), [y, b] = Ke({
    prop: r,
    defaultProp: o ?? !1,
    onChange: (S) => {
...
}), [Q0, J0] = ho(Ln, { isInside: !1 }), ex = /* @__PURE__ */ Ef("TooltipContent"), tu = u.forwardRef(
  (e, t) => {
    const {
      __scopeTooltip: n,
      children: r,
        ...
        children: /* @__PURE__ */ c.jsxs(
          to,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ c.jsx(Q0, { scope: n, isInside: !0, children: /* @__PURE__ */ c.jsx(_f, { id: l.contentId, role: "tooltip", children: o || r }) })
            ]
          }
        )
      }
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const Tx = [["path", { d: "M4 7h16", key: "svg-0" }], ["path", { d: "M5 7l1 12a2 2 0 0 0 2 2h8a2 2 0 0 0 2 -2l1 -12", key: "svg-1" }], ["path", { d: "M9 7v-3a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v3", key: "svg-2" }], ["path", { d: "M10 12l4 4m0 -4l-4 4", key: "svg-3" }]], Wx = we("outline", "trash-x", "TrashX", Tx);
/**
 * @license @tabler/icons-react v3.35.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */
const Lx = [["path", { d: "M18 6l-12 12", key: "svg-0" }], ["path", { d: "M6 6l12 12", key: "svg-1" }]], da = we("outline", "x", "X", Lx);
/**
 * @license @tabler/icons-react v3.35.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */
const Fx = [["path", { d: "M12 2c5.523 0 10 4.477 10 10a10 10 0 0 1 -19.995 .324l-.005 -.324l.004 -.28c.148 -5.393 4.566 -9.72 9.996 -9.72zm.01 13l-.127 .007a1 1 0 0 0 0 1.986l.117 .007l.127 -.007a1 1 0 0 0 0 -1.986l-.117 -.007zm-.01 -8a1 1 0 0 0 -.993 .883l-.007 .117v4l.007 .117a1 1 0 0 0 1.986 0l.007 -.117v-4l-.007 -.117a1 1 0 0 0 -.993 -.883z", key: "svg-0" }]], $x = we("filled", "alert-circle-filled", "AlertCircleFilled", Fx);
/**
 * @license @tabler/icons-react v3.35.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */
const Vx = [["path", { d: "M17 3.34a10 10 0 1 1 -14.995 8.984l-.005 -.324l.005 -.324a10 10 0 0 1 14.995 -8.336zm-1.293 5.953a1 1 0 0 0 -1.32 -.083l-.094 .083l-3.293 3.292l-1.293 -1.292l-.094 -.083a1 1 0 0 0 -1.403 1.403l.083 .094l2 2l.094 .083a1 1 0 0 0 1.226 0l.094 -.083l4 -4l.083 -.094a1 1 0 0 0 -.083 -1.32z", key: "svg-0" }]], iu = we("filled", "circle-check-filled", "CircleCheckFilled", Vx);
/**
 * @license @tabler/icons-react v3.35.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */
const Bx = [["path", { d: "M17 3.34a10 10 0 1 1 -15 8.66l.005 -.324a10 10 0 0 1 14.995 -8.336m-5 11.66a1 1 0 0 0 -1 1v.01a1 1 0 0 0 2 0v-.01a1 1 0 0 0 -1 -1m0 -7a1 1 0 0 0 -1 1v4a1 1 0 0 0 2 0v-4a1 1 0 0 0 -1 -1", key: "svg-0" }]], Gs = we("filled", "exclamation-circle-filled", "ExclamationCircleFilled", Bx);
/**
 * @license @tabler/icons-react v3.35.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */
const zx = [["path", { d: "M9 3a1 1 0 0 1 .608 .206l.1 .087l2.706 2.707h6.586a3 3 0 0 1 2.995 2.824l.005 .176v8a3 3 0 0 1 -2.824 2.995l-.176 .005h-14a3 3 0 0 1 -2.995 -2.824l-.005 -.176v-11a3 3 0 0 1 2.824 -2.995l.176 -.005h4z", key: "svg-0" }]], Us = we("filled", "folder-filled", "FolderFilled", zx);
/**
 * @license @tabler/icons-react v3.35.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */
const Hx = [["path", { d: "M12 2c5.523 0 10 4.477 10 10a10 10 0 0 1 -19.995 .324l-.005 -.324l.004 -.28c.148 -5.393 4.566 -9.72 9.996 -9.72zm0 9h-1l-.117 .007a1 1 0 0 0 0 1.986l.117 .007v3l.007 .117a1 1 0 0 0 .876 .876l.117 .007h1l.117 -.007a1 1 0 0 0 .876 -.876l.007 -.117l-.007 -.117a1 1 0 0 0 -.764 -.857l-.112 -.02l-.117 -.006v-3l-.007 -.117a1 1 0 0 0 -.876 -.876l-.117 -.007zm.01 -3l-.127 .007a1 1 0 0 0 0 1.986l.117 .007l.127 -.007a1 1 0 0 0 0 -1.986l-.117 -.007z", key: "svg-0" }]], Nr = we("filled", "info-circle-filled", "InfoCircleFilled", Hx), rs = "-", Yx = (e) => {
  const t = Ux(e), {
  ...
  if (Ks.test(e)) {
    const t = Ks.exec(e)[1], n = t == null ? void 0 : t.substring(0, t.indexOf(":"));
    if (n)
      return "arbitrary.." + n;
  }
}, Ux = (e) => {
...
const Ce = (e) => {
  ...
  sb.test(e) && !ib.test(e)
), fu = () => !1, fb = (e) => cb.test(e), mb = (e) => lb.test(e), pb = (e) => !J(e) && !ee(e), hb = (e) => gn(e, hu, fu), J = (e) => du.test(e), jt = (e) => gn(e, vu, ub), To = (e) => gn(e, yb, le), Zs = (e) => gn(e, mu, fu), vb = (e) => gn(e, pu, mb), vr = (e) => gn(e, gu, fb), ee = (e) => uu.test(e), En = (e) => xn(e, vu), gb = (e) => xn(e, wb), Qs = (e) => xn(e, mu), xb = (e) => xn(e, hu), bb = (e) => xn(e, pu), gr = (e) => xn(e, gu, !0), gn = (e, t, n) => {
  const r = du.exec(e);
  return r ? r[1] ? t(r[1]) : n(r[2]) : !1;
}, xn = (e, t, n = !1) => {
  const r = uu.exec(e);
  return r ? r[1] ? t(r[1]) : n : !1;
}, mu = (e) => e === "position" || e === "percentage", pu = (e) => e === "image" || e === "url", hu = (e) => e === "length" || e === "size" || e === "bg-size", vu = (e) => e === "length", yb = (e) => e === "number", wb = (e) => e === "family-name", gu = (e) => e === "shadow", Js = () => {
  const e = Ce("color"), t = Ce("font"), n = Ce("text"), r = Ce("font-weight"), o = Ce("tracking"), a = Ce("leading"), s = Ce("breakpoint"), i = Ce("container"), l = Ce("spacing"), d = Ce("radius"), f = Ce("shadow"), m = Ce("inset-shadow"), p = Ce("text-shadow"), v = Ce("drop-shadow"), x = Ce("blur"), h = Ce("perspective"), g = Ce("aspect"), y = Ce("ease"), b = Ce("animate"), w = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], k = () => [
    ...
    span: ["full", wt, ee, J]
  }, wt, ee, J], B = () => [wt, "auto", ee, J], X = () => ["auto", "min", "max", "fr", ee, J], j = () => ["start", "end", "center", "between", "around", "evenly", "stretch", "baseline", "center-safe", "end-safe"], Y = () => ["start", "end", "center", "stretch", "center-safe", "end-safe"], $ = () => ["auto", ...P()], K = () => [en, "auto", "full", "dvw", "dvh", "lvw", "lvh", "svw", "svh", "min", "max", "fit", ...P()], D = () => [e, ee, J], W = () => [...k(), Qs, Zs, {
    position: [ee, J]
  }], R = () => ["no-repeat", {
    ...
    ee,
    J
  ], I = () => ["", le, En, jt], L = () => ["solid", "dashed", "dotted", "double"], Z = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], O = () => [le, jo, Qs, Zs], q = () => [
    // Deprecated since Tailwind CSS v4.0.0
    "",
    "none",
    x,
...
}, Sb = (e, ...t) => typeof e == "function" ? Xs(Js, e, ...t) : Xs(() => Cb(Js(), e), ...t), kb = Sb({
  extend: {
    theme: {
...
function Wt(e, t) {
  try {
    ...
    return r in On ? On[r] : ni(r, r.split(":"));
  } catch {
...
const Cu = 6048e5, jb = 864e5, oi = Symbol.for("constructDateFrom");
function Se(e, t) {
...
const li = (e, t) => {
  ...
  return a.replace("{{date}}", li(r, t)).replace("{{time}}", Iu(o, t));
}, Ay = {
  p: Iu,
  P: Dy
...
const di = 5, tw = 4;
function nw(e, t) {
  const n = t.startOfMonth(e), r = n.getDay() > 0 ? n.getDay() : 7, o = t.addDays(e, -r + 1), a = t.addDays(o, di * 7 - 1);
  return t.getMonth(e) === t.getMonth(a) ? di : tw;
}
function ju(e, t) {
...
function y1(e, t) {
  const [n, r] = v1(e, t), { startOfMonth: o, endOfMonth: a } = t, s = ui(e, n, r, t), [i, l] = go(
    s,
...
function w1(e, t, n, r) {
  ...
  for (const s of e) {
    const i = t(s);
    fi(i) && (i[ge.focused] && a < ot.FocusedModifier ? (o = s, a = ot.FocusedModifier) : r != null && r.isEqualTo(s) && a < ot.LastFocused ? (o = s, a = ot.LastFocused) : n(s.date) && a < ot.Selected ? (o = s, a = ot.Selected) : i[ge.today] && a < ot.Today && (o = s, a = ot.Today));
  }
...
function E1(e, t, n = mt) {
  const r = Array.isArray(t) ? t : [t];
  if (r.filter((i) => typeof i != "function").some((i) => typeof i == "boolean" ? i : n.isDate(i) ? vt(e, i, !1, n) : Bu(i, n) ? i.some((l) => vt(e, l, !1, n)) : ss(i) ? i.from && i.to ? mi(e, { from: i.from, to: i.to }, n) : !1 : Vu(i) ? N1(e, i.dayOfWeek, n) : Lu(i) ? n.isAfter(i.before, i.after) ? mi(e, {
...
function A1(e) {
  ...
  }), [i, t.className, t.style, C]), $e = Tw(t), Xt = _n(null);
  u1(Xt, !!t.animate, {
    classNames: i,
    months: Y,
    focused: Z,
      ...
      N.createElement(
        ...
        Y.map((se, ve) => N.createElement(
          ...
          N.createElement(n.MonthCaption, { "data-animated-caption": t.animate ? "true" : void 0, className: i[ne.MonthCaption], style: C == null ? void 0 : C[ne.MonthCaption], calendarMonth: se, displayIndex: ve }, l != null && l.startsWith("dropdown") ? N.createElement(
            ...
            (() => {
              const oe = l === "dropdown" || l === "dropdown-months" ? N.createElement(n.MonthsDropdown, { key: "month", className: i[ne.MonthsDropdown], "aria-label": ke(), classNames: i, components: n, disabled: !!t.disableNavigation, onChange: cs(se.date), options: Gw(se.date, $, K, r, a), style: C == null ? void 0 : C[ne.Dropdown], value: a.getMonth(se.date) }) : N.createElement("span", { key: "month" }, P(se.date, a)), pe = l === "dropdown" || l === "dropdown-years" ? N.createElement(n.YearsDropdown, { key: "year", className: i[ne.YearsDropdown], "aria-label": _t(a.options), classNames: i, components: n, disabled: !!t.disableNavigation, onChange: pt(se.date), options: qw($, K, r, a, !!t.reverseYears), style: C == null ? void 0 : C[ne.Dropdown], value: a.getYear(se.date) }) : N.createElement("span", { key: "year" }, B(se.date, a));
          ...
          N.createElement(
            ...
            N.createElement(n.Weeks, { "data-animated-weeks": t.animate ? "true" : void 0, className: i[ne.Weeks], style: C == null ? void 0 : C[ne.Weeks] }, se.weeks.map((oe) => N.createElement(
              ...
              oe.days.map((pe) => {
                ...
                const ls = Uw(fe, C, t.modifiersStyles), kn = Iw(fe, i, t.modifiersClassNames), ds = !yn && !fe.hidden ? ie(Ie, fe, a.options, a) : void 0;
                return (
                  // biome-ignore lint/a11y/useSemanticElements: react component
                  N.createElement(n.Day, { key: `${a.format(Ie, "yyyy-MM-dd")}_${a.format(pe.displayMonth, "yyyy-MM")}`, day: pe, modifiers: fe, className: kn.join(" "), style: ls, role: "gridcell", "aria-selected": fe.selected || void 0, "aria-label": ds, "data-day": a.format(Ie, "yyyy-MM-dd"), "data-month": pe.outside ? a.format(Ie, "yyyy-MM") : void 0, "data-selected": fe.selected || void 0, "data-disabled": fe.disabled || void 0, "data-hidden": fe.hidden || void 0, "data-outside": pe.outside || void 0, "data-focused": fe.focused || void 0, "data-today": fe.today || void 0 }, !fe.hidden && yn ? N.createElement(n.DayButton, { className: i[ne.DayButton], style: C == null ? void 0 : C[ne.DayButton], type: "button", day: pe, modifiers: fe, disabled: fe.disabled || void 0, tabIndex: O(pe) ? 0 : -1, "aria-label": re(Ie, fe, a.options, a), onClick: wn(pe, fe), onBlur: ar(pe, fe), onFocus: Cn(pe, fe), onKeyDown: Ye(pe, fe), onMouseEnter: Ge(pe, fe), onMouseLeave: Sn(pe, fe) }, S(Ie, a.options, a)) : !fe.hidden && S(pe.date, a.options, a))
                );
              })
            )))
          )
...
const hi = ae(
  ...
  ({
    ...
    return r ? /* @__PURE__ */ c.jsx(
      ...
      {
        ref: l,
        className: A(hi({ intent: t, size: n }), e),
        ...i,
        children: s
      }
    ) : /* @__PURE__ */ c.jsxs(
...
const k2 = [
  ...
  return /* @__PURE__ */ c.jsx(ka, { open: e, onOpenChange: t, children: /* @__PURE__ */ c.jsxs(tc, { children: [
    /* @__PURE__ */ c.jsx(
      Ma,
      {
  ...
  const [s, i] = cn(r), l = o !== void 0 ? o : s, d = N.Children.toArray(n).filter(
    (g) => N.isValidElement(g) && g.type === ef
  ), f = d.length, m = (g) => {
  ...
  return /* @__PURE__ */ c.jsx(Qu.Provider, { value: x, children: /* @__PURE__ */ c.jsxs(ka, { open: e, onOpenChange: h, children: [
    /* @__PURE__ */ c.jsx(
      Ma,
      {
        className: `bg-surface-scrimmed top-0 left-0 z-dialog fixed h-full
...
}, ef = ({ children: e }) => /* @__PURE__ */ c.jsx("div", { className: "flex flex-col", children: e }), N2 = ({ children: e }) => /* @__PURE__ */ c.jsx("div", { className: "px-xl py-lg flex items-center justify-between", children: /* @__PURE__ */ c.jsx(
  nc,
  {
  ...
  /* @__PURE__ */ c.jsx("div", { className: "gap-xs flex", children: t && /* @__PURE__ */ c.jsx(Ea, { asChild: !0, children: /* @__PURE__ */ c.jsx(qe, { intent: "tertiary", onClick: r, children: n }) }) }),
  ...
  return r ? /* @__PURE__ */ c.jsx(Ea, { asChild: !0, children: /* @__PURE__ */ c.jsx(qe, { ...o, onClick: i, children: e }) }) : /* @__PURE__ */ c.jsx(qe, { ...o, onClick: i, children: e });
}, mS = {
  Root: M2,
  Step: ef,
  Header: N2,
...
}, $2 = Nl, V2 = El, tf = N.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, o) => /* @__PURE__ */ c.jsx(Pl, { children: /* @__PURE__ */ c.jsx(
  Ua,
  {
    ref: o,
    align: t,
...
tf.displayName = Ua.displayName;
var gi = 1, B2 = 0.9, z2 = 0.8, H2 = 0.17, Ho = 0.1, Yo = 0.999, Y2 = 0.9999, G2 = 0.99, U2 = /[\\\/_+.#"@\[\(\{&]/, K2 = /[\\\/_+.#"@\[\(\{&]/g, q2 = /[\s-]/, nf = /[\s-]/g;
function ha(e, t, n, r, o, a, s) {
  if (a === t.length) return o === e.length ? gi : G2;
  var i = `${o},${a}`;
  if (s[i] !== void 0) return s[i];
  for (var l = r.charAt(a), d = n.indexOf(l, o), f = 0, m, p, v, x; d >= 0; ) m = ha(e, t, n, r, d + 1, a + 1, s), m > f && (d === o ? m *= gi : U2.test(e.charAt(d - 1)) ? (m *= z2, v = e.slice(o, d - 1).match(K2), v && o > 0 && (m *= Math.pow(Yo, v.length))) : q2.test(e.charAt(d - 1)) ? (m *= B2, x = e.slice(o, d - 1).match(nf), x && o > 0 && (m *= Math.pow(Yo, x.length))) : (m *= H2, o > 0 && (m *= Math.pow(Yo, d - o))), e.charAt(d) !== t.charAt(a) && (m *= Y2)), (m < Ho && n.charAt(d - 1) === r.charAt(a + 1) || r.charAt(a + 1) === r.charAt(a) && n.charAt(d - 1) !== r.charAt(a)) && (p = ha(e, t, n, r, d + 1, a + 2, s), p * Ho > m && (m = p * Ho)), m > f && (f = m), d = n.indexOf(l, d + 1);
  return s[i] = f, f;
}
function xi(e) {
  return e.toLowerCase().replace(nf, " ");
}
function X2(e, t, n) {
  return e = n && n.length > 0 ? `${e + " " + n.join(" ")}` : e, ha(e, t, xi(e), xi(t), 0, 0, {});
}
var Pn = '[cmdk-group=""]', Go = '[cmdk-group-items=""]', Z2 = '[cmdk-group-heading=""]', rf = '[cmdk-item=""]', bi = `${rf}:not([aria-disabled="true"])`, va = "cmdk-item-select", nn = "data-value", Q2 = (e, t, n) => X2(e, t, n), of = u.createContext(void 0), nr = () => u.useContext(of), af = u.createContext(void 0), is = () => u.useContext(af), sf = u.createContext(void 0), cf = u.forwardRef((e, t) => {
  let n = rn(() => {
    var E, _;
  ...
  }), r = rn(() => /* @__PURE__ */ new Set()), o = rn(() => /* @__PURE__ */ new Map()), a = rn(() => /* @__PURE__ */ new Map()), s = rn(() => /* @__PURE__ */ new Set()), i = lf(e), { label: l, children: d, value: f, onValueChange: m, filter: p, shouldFilter: v, loop: x, disablePointerSelection: h = !1, vimBindings: g = !0, ...y } = e, b = Ne(), w = Ne(), k = Ne(), C = u.useRef(null), M = lC();
  Bt(() => {
    if (f !== void 0) {
      let E = f.trim();
  ...
  function j() {
    var E;
    return (E = C.current) == null ? void 0 : E.querySelector(`${rf}[aria-selected="true"]`);
  }
  function Y() {
    var E;
    return Array.from(((E = C.current) == null ? void 0 : E.querySelectorAll(bi)) || []);
  }
  function $(E) {
    let _ = Y()[E];
  ...
  function D(E) {
    ...
    for (; I && !L; ) I = E > 0 ? iC(I, Pn) : cC(I, Pn), L = I == null ? void 0 : I.querySelector(bi);
  ...
  } }, u.createElement("label", { "cmdk-label": "", htmlFor: P.inputId, id: P.labelId, style: uC }, l), xo(e, (E) => u.createElement(af.Provider, { value: S }, u.createElement(of.Provider, { value: P }, E))));
}), J2 = u.forwardRef((e, t) => {
  var n, r;
  let o = Ne(), a = u.useRef(null), s = u.useContext(sf), i = nr(), l = lf(e), d = (r = (n = l.current) == null ? void 0 : n.forceMount) != null ? r : s == null ? void 0 : s.forceMount;
  Bt(() => {
    if (!d) return i.item(o, s == null ? void 0 : s.id);
  }, [d]);
  let f = df(o, a, [e.value, e.children, a], e.keywords), m = is(), p = Pt((M) => M.value && M.value === f.current), v = Pt((M) => d || i.filter() === !1 ? !0 : M.search ? M.filtered.items.get(o) > 0 : !0);
  u.useEffect(() => {
    let M = a.current;
  ...
  Bt(() => f.group(s), []), df(s, i, [e.value, e.heading, l]);
  let p = u.useMemo(() => ({ id: s, forceMount: o }), [o]);
  return u.createElement(Q.div, { ref: xt(i, t), ...a, "cmdk-group": "", role: "presentation", hidden: m ? void 0 : !0 }, n && u.createElement("div", { ref: l, "cmdk-group-heading": "", "aria-hidden": !0, id: d }, n), xo(e, (v) => u.createElement("div", { "cmdk-group-items": "", role: "group", "aria-labelledby": n ? d : void 0 }, u.createElement(sf.Provider, { value: p }, v))));
}), tC = u.forwardRef((e, t) => {
  ...
  let { onValueChange: n, ...r } = e, o = e.value != null, a = is(), s = Pt((d) => d.search), i = Pt((d) => d.selectedItemId), l = nr();
  return u.useEffect(() => {
  ...
  return u.createElement(ka, { open: n, onOpenChange: r }, u.createElement(tc, { container: s }, u.createElement(Ma, { "cmdk-overlay": "", className: o }), u.createElement(Na, { "aria-label": e.label, "cmdk-dialog": "", className: a }, u.createElement(cf, { ref: t, ...i }))));
...
}), Fe = Object.assign(cf, { List: rC, Item: J2, Input: nC, Group: eC, Separator: tC, Dialog: oC, Empty: aC, Loading: sC });
function iC(e, t) {
...
ff.displayName = Fe.Input.displayName;
...
mf.displayName = Fe.List.displayName;
const pf = N.forwardRef((e, t) => /* @__PURE__ */ c.jsx(
  Fe.Empty,
  {
    ref: t,
...
pf.displayName = Fe.Empty.displayName;
...
const hf = N.forwardRef(({ className: e, ...t }, n) => /* @__PURE__ */ c.jsx(
  Fe.Separator,
  {
    ref: n,
    className: A(
...
hf.displayName = Fe.Separator.displayName;
...
const yi = ae("ease-in-out transition-all duration-300", {
  variants: {
    variant: {
  ...
  ({
    ...
    return N.useEffect(() => {
      ...
      const T = I.length, G = $e(), de = G.filter((xe) => !xe.disabled).length;
      if (T !== Xe.current) {
        ...
        if (xe > 0) {
          const Pe = I.slice(-xe).map(
            (wo) => {
              var us;
              return (us = G.find((yf) => yf.value === wo)) == null ? void 0 : us.label;
            }
          ).filter(Boolean);
          Pe.length === 1 ? We(
    ...
    }, [I, Z, re, We, $e]), /* @__PURE__ */ c.jsxs(c.Fragment, { children: [
          ...
          children: [
            ...
            /* @__PURE__ */ c.jsx(
              tf,
              {
                ...
                align: "start",
                children: /* @__PURE__ */ c.jsxs(uf, { filter: yo, children: [
                  S && /* @__PURE__ */ c.jsx(
                    ff,
                    {
                      placeholder: g,
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ c.jsxs("div", { className: "gap-xs flex items-center", children: [
            /* @__PURE__ */ c.jsx("span", { className: A(wi()), children: i }),
            /* @__PURE__ */ c.jsx(
              ga,
              {
                value: o.toString(),
          ...
          /* @__PURE__ */ c.jsxs("div", { className: "gap-xs flex items-center", children: [
            /* @__PURE__ */ c.jsx("span", { className: A(wi()), children: l }),
            /* @__PURE__ */ c.jsx(
              ga,
              {
                value: e.toString(),
...
const vf = xa(void 0), _C = ({
  ...
  return /* @__PURE__ */ c.jsx(vf.Provider, { value: a, children: t });
}, rr = () => {
  const e = ba(vf);
  if (e === void 0)
    throw new Error(
  ...
  return e;
}, gf = N.forwardRef(({ className: e, ...t }, n) => {
...
gf.displayName = "SideNavigationCollapseButton";
const IC = ae(
...
), jC = N.forwardRef(({ defaultCollapsed: e = !1, ...t }, n) => /* @__PURE__ */ c.jsx(_C, { defaultCollapsed: e, children: /* @__PURE__ */ c.jsx(xf, { ref: n, ...t }) }));
jC.displayName = "SideNavigation";
const xf = N.forwardRef(
  ({
    className: e,
    width: t,
    header: n,
...
xf.displayName = "SideNavigationContent";
const TC = ae(
...
), bf = N.forwardRef(({ className: e, steps: t, currentStep: n, ...r }, o) => {
  ...
  B0,
  {
    ...
    children: /* @__PURE__ */ c.jsxs("div", { className: "gap-xs flex items-start justify-between", children: [
      /* @__PURE__ */ c.jsxs("div", { className: "gap-xxs flex items-start", children: [
        ...
        /* @__PURE__ */ c.jsxs("div", { children: [
          t && /* @__PURE__ */ c.jsx(z0, { className: "text-body-primary font-bold", children: /* @__PURE__ */ c.jsx(
            "h5",
            {
          ...
          /* @__PURE__ */ c.jsx(H0, { children: /* @__PURE__ */ c.jsx("p", { className: "text-md -my-1", children: e }) })
        ] })
      ] }),
      /* @__PURE__ */ c.jsx("div", { children: /* @__PURE__ */ c.jsx(Y0, { asChild: !0, altText: "Close", children: /* @__PURE__ */ c.jsx("button", { onClick: r, className: "block", children: /* @__PURE__ */ c.jsx(da, { className: "h-md text-body-primary w-md" }) }) }) })
    ] })
  }
), CS = ({
  children: e,
...
const Ci = ae(
  ...
  ({
    ...
    const [M, S] = cn(!1), P = _n(null), F = Me(
      ...
      "div",
      {
        className: A(Ci({ size: t, state: "default", disabled: s })),
        onDragEnter: F,
        onDragLeave: z,
        onDragOver: U,
        onDrop: B,
        ...
        /* @__PURE__ */ c.jsxs("div", { className: "flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ c.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ c.jsx(Wx, { size: 24, className: "text-shape-primary" })
            }
          )
        ] }),
...
export {
  ...
  gf as SideNavigationCollapseButton,
