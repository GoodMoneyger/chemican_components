...
function $g(e) {
  ...
  const [x, v] = m.useState(null), [g, w] = m.useState(null), b = m.useCallback((j) => {
    ...
    F.current && (j.platform = F.current), _g(P.current, S.current, j).then(($) => {
      ...
      T.current && !qr(E.current, Q) && (E.current = Q, Gn.flushSync(() => {
        f(Q);
      }));
    });
  }, [p, t, n, F, L]);
...
var gs = "PopperContent", [qg, Xg] = Cl(gs), El = m.forwardRef(
  (e, t) => {
    ...
    const M = (D = j.arrow) == null ? void 0 : D.x, _ = (Z = j.arrow) == null ? void 0 : Z.y, B = ((J = j.arrow) == null ? void 0 : J.centerOffset) !== 0, [K, Y] = m.useState();
    return Ie(() => {
...
var Qe = "MenuContent", [yx, Cs] = Qt(Qe), Bl = m.forwardRef(
  ...
  (e, t) => {
    const {
      ...
      var D, Z;
      const Q = I.current + $, R = N().filter((J) => !J.disabled), M = document.activeElement, _ = (D = R.find((J) => J.ref.current === M)) == null ? void 0 : D.textValue, B = R.map((J) => J.textValue), K = Ix(B, Q, _), Y = (Z = R.find((J) => J.textValue === K)) == null ? void 0 : Z.ref.current;
      (function J(se) {
...
), Mx = "MenuCheckboxItem", Yl = m.forwardRef(
  (e, t) => {
...
Yl.displayName = Mx;
var Gl = "MenuRadioGroup", [Ex, Px] = Qt(
  Gl,
...
var Cb = Yd, Sb = Kd, kb = qd, Nb = Xd, Mb = Zd, Eb = Qd, Pb = nu, Rb = ou, Ab = su, Db = cu, jb = lu, Ob = uu, _b = fu, Ib = mu, Tb = hu, $b = vu, Do = "Switch", [Fb] = Te(Do), [Lb, Wb] = Fb(Do), wu = m.forwardRef(
  (e, t) => {
    const {
      __scopeSwitch: n,
      name: r,
...
var Bb = wu, zb = Su, jo = "Tabs", [Hb] = Te(jo, [
  yn
]), Mu = yn(), [Yb, Os] = Hb(jo), Eu = m.forwardRef(
  (e, t) => {
    const {
      __scopeTabs: n,
      value: r,
...
function AC(e) {
  ...
  return k.createElement(
    ...
    k.createElement(
      n.Root,
      { rootRef: t.animate ? Ge : void 0, className: En, style: hr, dir: t.dir, id: t.id, lang: t.lang, nonce: t.nonce, title: t.title, role: t.role, "aria-label": t["aria-label"], "aria-labelledby": t["aria-labelledby"], ...Ze },
      k.createElement(
        n.Months,
        ...
        W.map((le, me) => k.createElement(
          ...
          k.createElement(n.MonthCaption, { "data-animated-caption": t.animate ? "true" : void 0, className: i[re.MonthCaption], style: C == null ? void 0 : C[re.MonthCaption], calendarMonth: le, displayIndex: me }, l != null && l.startsWith("dropdown") ? k.createElement(
            ...
            (() => {
              const ie = l === "dropdown" || l === "dropdown-months" ? k.createElement(n.MonthsDropdown, { key: "month", className: i[re.MonthsDropdown], "aria-label": oe(), classNames: i, components: n, disabled: !!t.disableNavigation, onChange: pr(le.date), options: Y2(le.date, V, U, r, a), style: C == null ? void 0 : C[re.Dropdown], value: a.getMonth(le.date) }) : k.createElement("span", { key: "month" }, E(le.date, a)), ye = l === "dropdown" || l === "dropdown-years" ? k.createElement(n.YearsDropdown, { key: "year", className: i[re.YearsDropdown], "aria-label": lr(a.options), classNames: i, components: n, disabled: !!t.disableNavigation, onChange: Mn(le.date), options: U2(V, U, r, a, !!t.reverseYears), style: C == null ? void 0 : C[re.Dropdown], value: a.getYear(le.date) }) : k.createElement("span", { key: "year" }, L(le.date, a));
          ...
          k.createElement(
            ...
            k.createElement(n.Weeks, { "data-animated-weeks": t.animate ? "true" : void 0, className: i[re.Weeks], style: C == null ? void 0 : C[re.Weeks] }, le.weeks.map((ie) => k.createElement(
              ...
              ie.days.map((ye) => {
                ...
                if (ve[ke.focused] = !ve.hidden && !!(Y != null && Y.isEqualTo(ye)), ve[et.selected] = (M == null ? void 0 : M(We)) || ve.selected, Bs(B)) {
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ c.jsx(
          AC,
          {
            ...
            autoFocus: !1,
            classNames: (() => {
              const S = Yf(), E = "text-interactive-primary-default hover:bg-interactive-neutral-hover hover:text-interactive-primary-hover transition-colors p-xxs cursor-pointer";
              return {
                // Root container
...
}, pm = Md, HS = Ed, YS = T0, Hs = k.forwardRef(({ className: e, align: t = "center", sideOffset: n = 4, ...r }, o) => /* @__PURE__ */ c.jsx(Pd, { children: /* @__PURE__ */ c.jsx(
  Ps,
  {
    ref: o,
    align: t,
...
var On = '[cmdk-group=""]', ga = '[cmdk-group-items=""]', ak = '[cmdk-group-heading=""]', xm = '[cmdk-item=""]', ec = `${xm}:not([aria-disabled="true"])`, Ya = "cmdk-item-select", sn = "data-value", sk = (e, t, n) => ok(e, t, n), bm = m.createContext(void 0), ir = () => m.useContext(bm), ym = m.createContext(void 0), Ys = () => m.useContext(ym), wm = m.createContext(void 0), Cm = m.forwardRef((e, t) => {
  ...
  function O(M, _) {
    ...
    return M ? Y(M, n.current.search, _) : 0;
  }
  function I() {
  ...
  function U(M) {
    var _;
    let B = T(), K = W(), Y = K.findIndex((Z) => Z === B), D = K[Y + M];
    (_ = i.current) != null && _.loop && (D = Y + M < 0 ? K[K.length - 1] : Y + M === K.length ? K[0] : K[Y + M]), D && S.setState("value", D.getAttribute(sn));
  }
  function j(M) {
...
Mm.displayName = Ye.Input.displayName;
...
Em.displayName = Ye.List.displayName;
...
const tc = ae("ease-in-out transition-all duration-300", {
  ...
  const le = (() => {
    ...
    let G;
    Mn(e) ? G = e.flatMap((Me) => Me.options) : G = e;
    ...
    const { option: ne, location: ce, onRemove: xe, disabled: Me } = G;
  ...
  k.useEffect(() => {
    if (!R) return;
    const G = pr.current;
    En(G, i) || (En(oe, i) || Se(i), pr.current = [...i]);
  }, [i, oe, En, R]);
  const qo = {
