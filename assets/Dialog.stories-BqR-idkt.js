import{e as te,j as e,r as p}from"./iframe-ByKsAiWX.js";import{B as y}from"./Button-zqgWnaH5.js";import{T as ne}from"./index-0El2dWFx.js";import{R as oe,P as ae,O as ie,C as le,T as re}from"./index-B17dQCJC.js";import"./preload-helper-Dp1pzeXC.js";import"./ProgressIndicator-93ao06oF.js";import"./TextField-BHTxDLBP.js";import"./Popover-TaL_JC-_.js";import"./index-DSD58PwI.js";import"./index-B1Rb1ULA.js";import"./createReactComponent-B6M0u6BN.js";import"./Tag-COjGRKnz.js";import"./tokens-ClON5slf.js";const ue=[{label:"Confirm",value:!0,intent:"primary"}],O=({isOpen:o,onClose:t,onCancel:n=b=>b(),title:a,children:l,busy:r,actions:u=ue,cancellable:m=!0,cancelButtonLabel:q="キャンセル",allowClickOutside:i=!0,onOpenAutoFocus:T})=>{const[b,S]=te.useState(-1),j=r!==void 0?r:b!==-1,$=async s=>{const w=u.indexOf(s);if(s.onAction){S(w);const D=await s.onAction(t);if(S(-1),D===!1)return}else S(-1);o&&t(s.value)},G=()=>{n(t)},X=s=>{s.preventDefault(),m&&!j&&i&&n(t)},Z=s=>{if(j){s.preventDefault();return}s.preventDefault(),n(t)};return e.jsx(oe,{open:o,onOpenChange:t,children:e.jsx(ae,{children:e.jsx(ie,{className:`bg-surface-scrimmed top-0 left-0 z-dialog fixed h-full
