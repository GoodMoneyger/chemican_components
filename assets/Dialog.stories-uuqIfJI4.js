import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as x}from"./iframe-Ca_YkOBi.js";import{B as g}from"./Button-5nRLLqiG.js";import{R as M,O as J,C as _,T as E,a as h}from"./index-MFnOnHT8.js";import"./preload-helper-Dp1pzeXC.js";import"./index-NTlVj9BQ.js";import"./utils-BPSo7OLS.js";import"./ProgressIndicator-YCP56O3S.js";import"./index-DF2O983p.js";import"./index-D12k-eco.js";import"./index-DicI6A-m.js";import"./index-DHGYJjf7.js";import"./index-D8aG6hgf.js";import"./index-BQEr83Nr.js";import"./index-BnWinVZx.js";import"./index-_9aeoUrp.js";import"./index-f-0_ynIO.js";import"./index-CI_tLFrz.js";const V=[{label:"Confirm",value:!0,intent:"primary"}],f=({isOpen:i,onClose:s,title:n,children:u,actions:m=V,cancellable:c=!0,cancelButtonLabel:p="キャンセル"})=>{const I=t=>{t.onAction&&t.onAction(),s(t.value)},R=()=>{s()};return e.jsxs(M,{open:i,onOpenChange:s,children:[e.jsx(J,{className:`bg-surface-scrimmed top-0 left-0 z-dialog fixed h-full
          ...
          -translate-y-1/2 transform`,children:e.jsxs("div",{className:"flex flex-col",children:[e.jsx("div",{className:"px-xl py-lg flex flex-grow items-center justify-between",children:n&&e.jsx(E,{className:`text-xxl text-body-primary font-bold h-4.5 flex
                  items-center`,children:n})}),e.jsx("div",{className:`border-divider-default bg-surface-secondary px-xl pt-md
              pb-xxl text-body-primary min-h-40 flex flex-grow-0 border-y-1`,children:u}),e.jsxs("div",{className:"px-xl py-md flex justify-between",children:[c&&e.jsx(h,{asChild:!0,children:e.jsx(g,{intent:"tertiary",onClick:R,children:p})}),e.jsx("div",{className:`gap-xs flex ${c?"":"ml-auto"}`,children:m.map((t,T)=>{const{label:B,classNames:q,onAction:z,value:P,...L}=t;return e.jsx(h,{asChild:!0,disabled:t.disabled,children:e.jsx(g,{...L,intent:t.intent||"primary",className:q,onClick:()=>I(t),children:B})},T)})})]})]})})]})};f.__docgenInfo={description:"",methods:[],displayName:"Dialog",props:{isOpen:{required:!0,tsType:{name:"boolean"},description:""},onClose:{required:!0,tsType:{name:"signature",type:"function",raw:"(value?: unknown) => void",signature:{arguments:[{type:{name:"unknown"},name:"value"}],return:{name:"void"}}},description:""},children:{required:!0,tsType:{name:"ReactNode"},description:""},title:{required:!0,tsType:{name:"ReactNode"},description:""},actions:{required:!1,tsType:{name:"Array",elements:[{name:"DialogAction"}],raw:"DialogAction[]"},description:"",defaultValue:{value:`[
  {
    label: 'Confirm',
    value: true,
    intent: 'primary',
  },
]`,computed:!1}},cancellable:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},cancelButtonLabel:{required:!1,tsType:{name:"ReactNode"},description:"",defaultValue:{value:"'キャンセル'",computed:!1}}}};const re={title:"Components/Dialog",component:f,parameters:{radixDocs:{primitive:"Dialog",url:"https://www.radix-ui.com/primitives/docs/components/dialog"}}},d=i=>{const[s,n]=x.useState(i.isOpen),[u,m]=x.useState(null),c=p=>{n(!1),m(p),console.log("Dialog closed with value:",p)};return e.jsxs(e.Fragment,{children:[e.jsx(g,{intent:"secondary",onClick:()=>n(!0),children:"Open Modal"}),u&&e.jsxs("p",{style:{marginTop:"10px",color:"#666"},children:["Last result: ",JSON.stringify(u)]}),e.jsx(f,{...i,isOpen:s,onClose:c})]})},o=d.bind({});o.args={isOpen:!1,title:"Confirmation Dialog",children:"Are you sure you want to proceed with this action?",actions:[{label:"Confirm",value:!0,intent:"primary"}]};const l=d.bind({});l.args={isOpen:!1,title:"Save Document",children:"Choose how you want to save your document.",actions:[{label:"Save as Draft",value:"draft",intent:"secondary"},{label:"Publish",value:"publish",intent:"primary"}]};const a=d.bind({});a.args={isOpen:!1,title:"Required Action",children:"You must choose one of the following options to continue.",cancellable:!1,actions:[{label:"Option A",value:"optionA",intent:"secondary"},{label:"Option B",value:"optionB",intent:"primary"}]};const r=d.bind({});r.args={isOpen:!1,title:"Custom Actions",children:"This dialog demonstrates custom action handlers.",actions:[{label:"Log Info",value:"info",intent:"tertiary",onAction:()=>console.log("Info action triggered")},{label:"Delete",value:"delete",intent:"text",onAction:()=>console.log("Delete action triggered"),classNames:"text-red-600 hover:bg-red-50"},{label:"Save",value:"save",intent:"primary",onAction:()=>console.log("Save action triggered")}]};var y,O,v;o.parameters={...o.parameters,docs:{...(y=o.parameters)==null?void 0:y.docs,source:{originalSource:`args => {
