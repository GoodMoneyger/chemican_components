import{e as ne,j as e,c as oe,r as p}from"./iframe-DHVYCqvJ.js";import{B as y}from"./Button-Dk8HBCC8.js";import{T as ae}from"./index-BdG2OFvP.js";import{R as ie,P as le,O as re,C as ue,T as ce}from"./index-CPicRVzQ.js";import"./preload-helper-Dp1pzeXC.js";import"./ProgressIndicator-DFt7OpXH.js";import"./TextField-6IW9KUJn.js";import"./useCompositionGuard-cI6d8-WY.js";import"./Popover-pOLp93JJ.js";import"./index-CndjLCik.js";import"./index-l7D_wAD5.js";import"./createReactComponent-3D78oVz3.js";import"./Tag-BSVEaqp5.js";import"./tokens-ClON5slf.js";const de=[{label:"Confirm",value:!0,intent:"primary"}],O=({isOpen:o,onClose:t,onCancel:n=b=>b(),title:a,children:l,busy:r,actions:u=de,cancellable:m=!0,cancelButtonLabel:w="キャンセル",allowClickOutside:i=!0,onOpenAutoFocus:T,bodyClassName:$})=>{const[b,S]=ne.useState(-1),j=r!==void 0?r:b!==-1,G=async s=>{const q=u.indexOf(s);if(s.onAction){S(q);const D=await s.onAction(t);if(S(-1),D===!1)return}else S(-1);o&&t(s.value)},X=()=>{n(t)},Z=s=>{s.preventDefault(),m&&!j&&i&&n(t)},ee=s=>{if(j){s.preventDefault();return}s.preventDefault(),n(t)};return e.jsx(ie,{open:o,onOpenChange:t,children:e.jsx(le,{children:e.jsx(re,{className:`bg-surface-scrimmed top-0 left-0 z-dialog fixed h-full
