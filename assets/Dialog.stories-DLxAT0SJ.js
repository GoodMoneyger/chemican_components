import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{e as z,r as v}from"./iframe-iCWLE-HY.js";import{B as O}from"./Button-DUQvBshD.js";import{R as K,P as $,O as G,C as Q,T as X}from"./index-J5uBeo-o.js";import"./preload-helper-Dp1pzeXC.js";import"./index-BIYrq5Mo.js";import"./utils-ChJrdkvV.js";import"./ProgressIndicator-A738xv8x.js";import"./index-B9W2vWZ8.js";import"./index-B-nGZTkM.js";import"./index-Bg_Sek3Q.js";import"./index-ghbK3je5.js";import"./index-C5tMeMa9.js";import"./index-C0t8puKt.js";import"./index--K2c9udF.js";import"./index-D2W6Iczv.js";import"./index-DoyCrgAF.js";import"./index-toa-FtPI.js";const Z=[{label:"Confirm",value:!0,intent:"primary"}],x=({isOpen:a,onClose:t,onCancel:n=p=>p(),title:l,children:u,busy:r,actions:i=Z,cancellable:d=!0,cancelButtonLabel:b="キャンセル",allowClickOutside:o=!0})=>{const[p,w]=z.useState(-1),S=r!==void 0?r:p!==-1,_=async s=>{const y=i.indexOf(s);if(s.onAction){w(y);const k=await s.onAction(t);if(w(-1),k===!1)return}else w(-1);a&&t(s.value)},V=()=>{n(t)},W=s=>{s.preventDefault(),d&&!S&&o&&n(t)},F=s=>{if(S){s.preventDefault();return}s.preventDefault(),n(t)};return e.jsx(K,{open:a,onOpenChange:t,children:e.jsx($,{children:e.jsx(G,{className:`bg-surface-scrimmed top-0 left-0 z-dialog fixed h-full
