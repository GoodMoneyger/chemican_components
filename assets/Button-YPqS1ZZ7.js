import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{e as z}from"./iframe-BpubQJy7.js";import{c as g}from"./index-C632Crfe.js";import{S as O}from"./Spinner-CfF9-d-W.js";import{c as s,r as x}from"./utils-qNGXpGMI.js";import{S as w}from"./index-DTNTY2bb.js";const m=g(`gap-xxs rounded font-medium box-border inline-flex cursor-pointer
  ...
  disabled:no-underline`,{variants:{intent:{primary:`bg-interactive-primary-default text-interactive-inverse
        ...
        hover:bg-interactive-neutral-alert-hover
        active:bg-interactive-neutral-alert-active
        active:text-interactive-alert-active`}],defaultVariants:{intent:"primary",size:"md"}}),p=g("",{variants:{ghost:{true:""},iconOnly:{true:""},size:{xs:"size-4",sm:"size-5",md:"size-5",lg:"size-6",xl:"size-7"}},defaultVariants:{size:"md"}}),y=z.forwardRef(({intent:t,size:a,className:c,icon:i,asChild:h=!1,loading:f=!1,danger:o=!1,children:r,...n},d)=>{const v=h?w:"button",l=!!(i&&!r),u=!!(r&&!i),b=f||n.disabled;return f?e.jsxs(v,{ref:d,className:s(m({intent:t,size:a,iconOnly:l,textOnly:u,danger:o}),"relative",c),...n,disabled:b,children:[e.jsxs("span",{className:"gap-xxs invisible flex items-center",children:[x(i,{className:s(p({size:a,iconOnly:l,ghost:t==="ghost"}))}),r]}),e.jsx("span",{className:"inset-0 absolute flex items-center justify-center",children:e.jsx(O,{size:"sm",layout:"row"})})]}):i?e.jsxs(v,{ref:d,className:s(m({intent:t,size:a,iconOnly:l,textOnly:u,danger:o}),c),...n,disabled:b,children:[x(i,{className:s(p({size:a,iconOnly:l,ghost:t==="ghost"}))}),r]}):e.jsx(v,{ref:d,className:s(m({intent:t,size:a,textOnly:u,danger:o}),c),children:r,...n,disabled:b})});y.displayName="Button";y.__docgenInfo={description:"",methods:[],displayName:"Button",props:{asChild:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},icon:{required:!1,tsType:{name:"union",raw:"React.ReactNode | TablerIcon",elements:[{name:"ReactReactNode",raw:"React.ReactNode"},{name:"TablerIcon"}]},description:""},loading:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},danger:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}},composes:["VariantProps"]};export{y as B};
