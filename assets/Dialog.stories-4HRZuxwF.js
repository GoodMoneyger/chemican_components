import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{e as z,r as v}from"./iframe-DyWolvg4.js";import{B as O}from"./Button-CTXzzmRe.js";import{R as K,P as $,O as G,C as Q,T as X}from"./index-DPd_RFmh.js";import"./preload-helper-Dp1pzeXC.js";import"./index-D1riGgrV.js";import"./utils-DA56nRVL.js";import"./ProgressIndicator-DdB8pm-X.js";import"./index-Cf4Gq6Or.js";import"./index-DJMbtA3D.js";import"./index-CHfvmqer.js";import"./index-CUmYxWtU.js";import"./index-Cg_Kei1h.js";import"./index-B8UtrTq0.js";import"./index-UoN0s2iQ.js";import"./index-Bvay7Rhb.js";import"./index-BBSulk_m.js";import"./index-DG5ohEWk.js";const Z=[{label:"Confirm",value:!0,intent:"primary"}],x=({isOpen:a,onClose:t,onCancel:n=p=>p(),title:l,children:u,busy:r,actions:i=Z,cancellable:d=!0,cancelButtonLabel:b="キャンセル",allowClickOutside:o=!0})=>{const[p,w]=z.useState(-1),S=r!==void 0?r:p!==-1,_=async s=>{const y=i.indexOf(s);if(s.onAction){w(y);const k=await s.onAction(t);if(w(-1),k===!1)return}else w(-1);a&&t(s.value)},V=()=>{n(t)},W=s=>{s.preventDefault(),d&&!S&&o&&n(t)},F=s=>{if(S){s.preventDefault();return}s.preventDefault(),n(t)};return e.jsx(K,{open:a,onOpenChange:t,children:e.jsx($,{children:e.jsx(G,{className:`bg-surface-scrimmed top-0 left-0 z-dialog fixed h-full
