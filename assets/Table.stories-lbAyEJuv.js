import{e as m,j as e,c as T}from"./iframe-BpBz7moh.js";import{S as g}from"./StatusIndicator-M38oR1wJ.js";import{a as h}from"./Checkbox-CY6VTtJf.js";import{T as x}from"./Tag-ONSGzNzn.js";import{B as C}from"./Button-vLtfadYy.js";import{P as $}from"./ProgressIndicator-BdPxj9rW.js";import{I as O}from"./IconExternalLink-DxKSdCwR.js";import{I as W}from"./IconFileCheck-DIq8m75K.js";import"./preload-helper-Dp1pzeXC.js";import"./IconMinus-D_TVG9_O.js";import"./createReactComponent-CLenebly.js";import"./IconCheck-CIzTkiHP.js";import"./index-BkwPO7Ti.js";import"./tokens-ClON5slf.js";const w={loading:!1,loadingText:"ローディング中…"},X=m.createContext(w),Y=()=>m.useContext(X),v=m.forwardRef(({className:r,children:i,loading:a=w.loading,loadingText:c=w.loadingText,...o},n)=>{const s={loading:a,loadingText:c};return e.jsx(X.Provider,{value:s,children:e.jsx("table",{ref:n,className:T(`border-surface-default bg-surface-primary relative caption-bottom
            border`,r),...o,children:i})})});v.displayName="Table";const D=m.forwardRef(({className:r,loading:i,children:a,...c},o)=>{const{loading:n}=Y(),s=i??n;return e.jsxs("thead",{ref:o,className:T("text-sm bg-surface-tertiary top-0 z-slight sticky",r),...c,children:[a,s&&e.jsx("tr",{children:e.jsx("td",{colSpan:100,className:"p-0 h-0",children:e.jsx($.Linear,{indeterminate:!0,className:`bg-surface-primary border-b-divider-default
