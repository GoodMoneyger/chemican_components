import{j as e,r as P}from"./iframe-Cq0v7W-y.js";import{B as t}from"./Button-C7Mv6BnJ.js";import{I as A}from"./IconAlertCircle-BAxl3fUg.js";import{I as E}from"./IconExternalLink-yh7BxWuU.js";import{I as M}from"./IconAlertTriangle-BeCCZDgk.js";import{I as V}from"./IconCalendarEvent-Lk--4TE8.js";import{I as W}from"./IconCheck-CmuVW0tA.js";import{I as L}from"./IconChevronDown-BxBDMKuO.js";import{I as F}from"./IconChevronLeft-yMULCNTd.js";import{I as X}from"./IconChevronRight-0KNdHGfz.js";import{I as $}from"./IconChevronUp-C4yd52TB.js";import{I as U}from"./IconEdit-N-JzTgWp.js";import{a as q,I as G}from"./IconEye-Dw7FWr6q.js";import{I as J}from"./IconFileCheck-CZpf5NR2.js";import{c as K}from"./createReactComponent-DKWBqQCm.js";import{I as Q}from"./IconInfoCircle-CtdtjW71.js";import{I as Y}from"./IconMinus-CuKu_gfV.js";import{I as O}from"./IconPlus-C83ma7aa.js";import{I as r}from"./IconSearch-BEnds8Bu.js";import{I as o}from"./IconSettings-CoJLumMV.js";import{I as D}from"./IconTrash-61QfyWfC.js";import{I as H}from"./IconUser-aFS8OC3E.js";import{I as Z}from"./IconX-BMN2I5Kg.js";import"./preload-helper-Dp1pzeXC.js";import"./ProgressIndicator-DChSnH0J.js";/**
 * @license @tabler/icons-react v3.35.0 - MIT
 *
 * This source code is licensed under the MIT license.
 * See the LICENSE file in the root directory of this source tree.
 */const ee=[["path",{d:"M5 12l-2 0l9 -9l9 9l-2 0",key:"svg-0"}],["path",{d:"M5 12v7a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-7",key:"svg-1"}],["path",{d:"M9 21v-6a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v6",key:"svg-2"}]],R=K("outline","home","Home",ee),we={title:"Components/Tabler Icons",parameters:{docs:{description:{component:"Tabler Icons are a set of over 4,000 MIT-licensed icons for web projects. This library re-exports all Tabler icons for convenient use."}}}},se=[{name:"IconAlertCircle",Component:A},{name:"IconAlertTriangle",Component:M},{name:"IconCalendarEvent",Component:V},{name:"IconCheck",Component:W},{name:"IconChevronDown",Component:L},{name:"IconChevronLeft",Component:F},{name:"IconChevronRight",Component:X},{name:"IconChevronUp",Component:$},{name:"IconEdit",Component:U},{name:"IconExternalLink",Component:E},{name:"IconEye",Component:q},{name:"IconEyeOff",Component:G},{name:"IconFileCheck",Component:J},{name:"IconHome",Component:R},{name:"IconInfoCircle",Component:Q},{name:"IconMinus",Component:Y},{name:"IconPlus",Component:O},{name:"IconSearch",Component:r},{name:"IconSettings",Component:o},{name:"IconTrash",Component:D},{name:"IconUser",Component:H},{name:"IconX",Component:Z}],oe=({name:s})=>{const[n,a]=P.useState(!1),_=async()=>{await navigator.clipboard.writeText(s),a(!0),setTimeout(()=>a(!1),2e3)};return e.jsx("code",{className:`text-xs text-body-secondary hover:text-body-primary
        cursor-pointer transition-colors`,onClick:_,title:"Click to copy",children:n?"Copied!":s})},c={render:()=>e.jsxs("div",{className:"gap-4 flex flex-col",children:[e.jsx("div",{className:"gap-2 rounded-lg bg-surface-secondary p-4 flex flex-col",children:e.jsxs("p",{className:"text-sm",children:["This is a small selection of commonly used icons. Browse all 4,000+ icons in the"," ",e.jsxs("a",{href:"https://tabler.io/icons",target:"_blank",rel:"noopener noreferrer",className:`gap-1 text-body-primary inline-flex items-center
              underline`,children:["Tabler Icons catalog",e.jsx(E,{size:14})]})]})}),e.jsx("div",{className:"gap-4 md:grid-cols-4 lg:grid-cols-6 grid grid-cols-3",children:se.map(({name:s,Component:n})=>e.jsxs("div",{className:"gap-2 rounded-lg p-4 flex flex-col items-center border",children:[e.jsx(n,{size:48}),e.jsx(oe,{name:s})]},s))})]}),parameters:{docs:{description:{story:"A selection of commonly used Tabler icons in the library. Click on icon names to copy them."}}}},i={render:()=>e.jsxs("div",{className:"gap-4 rounded-md bg-surface-secondary p-4 flex flex-col",children:[e.jsx("h3",{className:"text-lg font-semibold",children:"Import and Usage"}),e.jsx("pre",{className:"rounded bg-surface-primary p-4 overflow-x-auto",children:e.jsx("code",{children:`import {
  IconSearch,
  IconUser,
  IconSettings,
  IconAlertCircle
...
<Button intent="tertiary" size="sm" icon={IconTrash} danger>
  Delete
</Button>`})})]}),parameters:{docs:{description:{story:"Examples of how Tabler icons are commonly used in real-world UI patterns like search inputs, alerts, navigation, and action buttons."}}}};var p,f,h;c.parameters={...c.parameters,docs:{...(p=c.parameters)==null?void 0:p.docs,source:{originalSource:`{
...
}`,...(h=(f=c.parameters)==null?void 0:f.docs)==null?void 0:h.source}}};var u,y,g;i.parameters={...i.parameters,docs:{...(u=i.parameters)==null?void 0:u.docs,source:{originalSource:`{
...
}`,...(g=(y=i.parameters)==null?void 0:y.docs)==null?void 0:g.source}}};var I,b,v;l.parameters={...l.parameters,docs:{...(I=l.parameters)==null?void 0:I.docs,source:{originalSource:`{
...
}`,...(v=(b=l.parameters)==null?void 0:b.docs)==null?void 0:v.source}}};var N,k,z;d.parameters={...d.parameters,docs:{...(N=d.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: () => <div className="gap-6 flex flex-col">
...
}`,...(S=(C=m.parameters)==null?void 0:C.docs)==null?void 0:S.source}}};var w,T,B;x.parameters={...x.parameters,docs:{...(w=x.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: () => <div className="gap-6 flex flex-col">
...
}`,...(B=(T=x.parameters)==null?void 0:T.docs)==null?void 0:B.source}}};const Te=["CommonIcons","UsageExample","SizeVariants","StrokeWidth","ColorVariants","RealWorldExamples"];export{m as ColorVariants,c as CommonIcons,x as RealWorldExamples,l as SizeVariants,d as StrokeWidth,i as UsageExample,Te as __namedExportsOrder,we as default};
