import{e as ne,j as e,c as oe,r as p}from"./iframe-CNuuLHLF.js";import{B as y}from"./Button-FeWq-7vH.js";import{T as ae}from"./index-Bj36K3q_.js";import{R as ie,P as le,O as re,C as ue,T as ce}from"./index-BBRbV_GH.js";import"./preload-helper-Dp1pzeXC.js";import"./ProgressIndicator-BWdJs7dR.js";import"./TextField-nfWu8Sff.js";import"./useCompositionGuard-DqgYriXC.js";import"./Popover-4UqbP5VD.js";import"./index-CtLZG8uD.js";import"./index-DtqiGSeK.js";import"./createReactComponent-Dj5kTZyf.js";import"./Tag-CzXYn7Kh.js";import"./tokens-ClON5slf.js";const de=[{label:"Confirm",value:!0,intent:"primary"}],O=({isOpen:o,onClose:t,onCancel:n=b=>b(),title:a,children:l,busy:r,actions:u=de,cancellable:m=!0,cancelButtonLabel:w="キャンセル",allowClickOutside:i=!0,onOpenAutoFocus:T,bodyClassName:$})=>{const[b,S]=ne.useState(-1),j=r!==void 0?r:b!==-1,G=async s=>{const q=u.indexOf(s);if(s.onAction){S(q);const D=await s.onAction(t);if(S(-1),D===!1)return}else S(-1);o&&t(s.value)},X=()=>{n(t)},Z=s=>{s.preventDefault(),m&&!j&&i&&n(t)},ee=s=>{if(j){s.preventDefault();return}s.preventDefault(),n(t)};return e.jsx(ie,{open:o,onOpenChange:t,children:e.jsx(le,{children:e.jsx(re,{className:`bg-surface-scrimmed top-0 left-0 z-dialog fixed h-full
