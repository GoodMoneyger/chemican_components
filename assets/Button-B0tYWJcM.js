import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{e as N}from"./iframe-D6ytM-q7.js";import{c as y}from"./index-hbrXODiu.js";import{S as O}from"./Spinner-71AfM7g4.js";import{c as a,r as o}from"./utils-BYuYr0rZ.js";import{S as R}from"./index-BYg-gC_y.js";const p=y(`gap-xxs rounded font-medium box-border inline-flex cursor-pointer
  ...
  disabled:no-underline`,{variants:{intent:{primary:`bg-interactive-primary-default text-interactive-inverse
        ...
        hover:bg-interactive-neutral-alert-hover
        active:bg-interactive-neutral-alert-active
        active:text-interactive-alert-active`}],defaultVariants:{intent:"primary",size:"md"}}),d=y("",{variants:{text:{true:""},iconOnly:{true:""},size:{xs:"size-4",sm:"size-5",md:"size-5",lg:"size-6",xl:"size-7"}},defaultVariants:{size:"md"}}),h=N.forwardRef(({intent:e,size:t,className:v,icon:i,trailingIcon:r,asChild:z=!1,loading:g=!1,danger:u=!1,children:l,...c},m)=>{const b=z?R:"button",s=!!((i||r)&&!l&&!(i&&r)),x=!!(l&&!i&&!r),f=g||c.disabled;return g?n.jsxs(b,{ref:m,className:a(p({intent:e,size:t,iconOnly:s,textOnly:x,danger:u}),"relative",v),...c,disabled:f,children:[n.jsxs("span",{className:"gap-xxs invisible flex items-center",children:[o(i,{className:a(d({size:t,iconOnly:s,text:e==="text"}))}),l,o(r,{className:a(d({size:t,iconOnly:s,ghost:e==="ghost"}))})]}),n.jsx("span",{className:"inset-0 absolute flex items-center justify-center",children:n.jsx(O,{size:"sm",layout:"row"})})]}):i||r?n.jsxs(b,{ref:m,className:a(p({intent:e,size:t,iconOnly:s,textOnly:x,danger:u}),v),...c,disabled:f,children:[o(i,{className:a(d({size:t,iconOnly:s,text:e==="text"}))}),l,o(r,{className:a(d({size:t,iconOnly:s,ghost:e==="ghost"}))})]}):n.jsx(b,{ref:m,className:a(p({intent:e,size:t,textOnly:x,danger:u}),v),children:l,...c,disabled:f})});h.displayName="Button";h.__docgenInfo={description:"",methods:[],displayName:"Button",props:{asChild:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},icon:{required:!1,tsType:{name:"union",raw:"React.ReactNode | TablerIcon",elements:[{name:"ReactReactNode",raw:"React.ReactNode"},{name:"TablerIcon"}]},description:""},trailingIcon:{required:!1,tsType:{name:"union",raw:"React.ReactNode | TablerIcon",elements:[{name:"ReactReactNode",raw:"React.ReactNode"},{name:"TablerIcon"}]},description:""},loading:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},danger:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}},composes:["VariantProps"]};export{h as B};
