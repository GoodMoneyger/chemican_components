import{e as O,j as n,S as N,n as o,l as a,m as g}from"./iframe-CmH369xt.js";import{P as w}from"./ProgressIndicator-DXzm4xwH.js";const p=g(`gap-xxs rounded font-normal box-border inline-flex cursor-pointer
  ...
  focus-visible:outline-none disabled:cursor-not-allowed disabled:no-underline`,{variants:{intent:{primary:`bg-interactive-primary-default text-interactive-inverse
        ...
        hover:bg-interactive-neutral-alert-hover
        active:bg-interactive-neutral-alert-active
        active:text-interactive-alert-active`}],defaultVariants:{intent:"primary",size:"md"}}),d=g("",{variants:{text:{true:""},iconOnly:{true:""},size:{icon:"size-4",xs:"size-4",sm:"size-5",md:"size-5",lg:"size-6",xl:"size-7"}},defaultVariants:{size:"md"}}),h=O.forwardRef(({intent:e,size:t,className:v,icon:i,trailingIcon:r,asChild:z=!1,loading:y=!1,danger:u=!1,children:l,...c},x)=>{const b=z?N:"button",s=!!((i||r)&&!l&&!(i&&r)),m=!!(l&&!i&&!r),f=y||c.disabled;return y?n.jsxs(b,{ref:x,className:a(p({intent:e,size:t,iconOnly:s,textOnly:m,danger:u}),"relative",v),...c,disabled:f,children:[n.jsxs("span",{className:"gap-xxs invisible flex items-center",children:[o(i,{className:a(d({size:t,iconOnly:s,text:e==="text"}))}),l,o(r,{className:a(d({size:t,iconOnly:s,text:e==="text"}))})]}),n.jsx("span",{className:"inset-0 absolute flex items-center justify-center",children:n.jsx(w.Circular,{size:"sm",layout:"row"})})]}):i||r?n.jsxs(b,{ref:x,className:a(p({intent:e,size:t,iconOnly:s,textOnly:m,danger:u}),v),...c,disabled:f,children:[o(i,{className:a(d({size:t,iconOnly:s,text:e==="text"}))}),l,o(r,{className:a(d({size:t,iconOnly:s,text:e==="text"}))})]}):n.jsx(b,{ref:x,className:a(p({intent:e,size:t,textOnly:m,danger:u}),v),children:l,...c,disabled:f})});h.displayName="Button";h.__docgenInfo={description:"",methods:[],displayName:"Button",props:{asChild:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},icon:{required:!1,tsType:{name:"union",raw:"React.ReactNode | TablerIcon",elements:[{name:"ReactReactNode",raw:"React.ReactNode"},{name:"TablerIcon"}]},description:""},trailingIcon:{required:!1,tsType:{name:"union",raw:"React.ReactNode | TablerIcon",elements:[{name:"ReactReactNode",raw:"React.ReactNode"},{name:"TablerIcon"}]},description:""},loading:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},danger:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}},composes:["VariantProps"]};export{h as B};
