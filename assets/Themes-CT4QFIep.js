...
`})}),`
`,e.jsx(n.p,{children:"All components reference these semantic tokens, so changing the theme updates all components automatically without requiring any component-level changes."})]})}function d(t={}){const{wrapper:n}={...s(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(o,{...t})}):o(t)}export{d as default};
