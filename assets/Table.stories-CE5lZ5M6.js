import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{e as c}from"./iframe-DgGHzgre.js";import{S}from"./StatusIndicator-N60gQH9x.js";import{a as h}from"./Checkbox-Bga505Qg.js";import{T as b}from"./Tag-_25S0jAW.js";import{c as u}from"./utils-DgJWGoGQ.js";import{P as M}from"./ProgressIndicator-BRSuvGYa.js";import{I as B}from"./IconExternalLink-CRs8R4_Y.js";import{I as P}from"./IconFileCheck-r0_42MLY.js";import"./preload-helper-Dp1pzeXC.js";import"./index-CE1wsEAN.js";import"./IconMinus-DXI4VOO6.js";import"./createReactComponent-E2LZs-nO.js";import"./IconCheck-BnYnassN.js";import"./index-Bdr1rpA9.js";import"./index-CIip4q7H.js";import"./index-fFcH9YUx.js";import"./index-NHK5GEmX.js";import"./index-B1tgyfUG.js";import"./index-C91cTPj3.js";import"./index-C7SOlUEz.js";import"./index-DMDq_rZ2.js";import"./tokens-ClON5slf.js";const g={loading:!1,loadingText:"ローディング中…"},L=c.createContext(g),U=()=>c.useContext(L),T=c.forwardRef(({className:a,children:o,loading:r=g.loading,loadingText:p=g.loadingText,...s},d)=>{const l={loading:r,loadingText:p};return e.jsx(L.Provider,{value:l,children:e.jsx("div",{className:`border-surface-default bg-surface-primary relative
            border`,children:e.jsx("table",{ref:d,className:u("w-full caption-bottom",a),...s,children:o})})})});T.displayName="Table";const v=c.forwardRef(({className:a,loading:o,children:r,...p},s)=>{const{loading:d}=U(),l=o??d;return e.jsxs("thead",{ref:s,className:u("text-sm bg-surface-tertiary top-0 sticky",a),...p,children:[r,l&&e.jsx("tr",{children:e.jsx("td",{colSpan:100,className:"p-0 h-0",children:e.jsx(M.Linear,{indeterminate:!0,className:`bg-surface-primary border-b-divider-default
                  box-content border-b`})})})]})});v.displayName="TableHeader";const D=c.forwardRef(({className:a,loading:o,loadingText:r,colSpan:p=1,children:s,...d},l)=>{const{loading:i,loadingText:A}=U(),E=o??i,I=r??A;return e.jsx("tbody",{ref:l,className:a,...d,children:E?e.jsx("tr",{children:e.jsx("td",{colSpan:p,className:"py-sm min-h-12 px-[1.44rem] text-center align-middle",children:I})}):s})});D.displayName="TableBody";const _=c.forwardRef(({className:a,...o},r)=>e.jsx("tfoot",{ref:r,className:u("bg-surface-secondary font-medium border-t",a),...o}));_.displayName="TableFooter";const f=c.forwardRef(({className:a,...o},r)=>e.jsx("tr",{ref:r,className:u(`border-surface-default [thead_&]:h-10 h-12
  ...
  return <div className="overflow-x-auto">
...
}`,...(R=(N=x.parameters)==null?void 0:N.docs)==null?void 0:R.source}}};var y,H,k;C.parameters={...C.parameters,docs:{...(y=C.parameters)==null?void 0:y.docs,source:{originalSource:`() => <Table loading>
    <TableHeader>
      <TableRow>
        <TableHead>
          <Checkbox label="" />
    ...
    <TableBody colSpan={6} />
  </Table>`,...(k=(H=C.parameters)==null?void 0:H.docs)==null?void 0:k.source}}};const ue=["Default","Loading"];export{x as Default,C as Loading,ue as __namedExportsOrder,me as default};
