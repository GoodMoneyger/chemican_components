import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{e as z}from"./iframe-FY7ut-By.js";import{c as x}from"./index-YATcduDS.js";import{c as s}from"./utils-BUuiPi5j.js";import{S as O}from"./Spinner-Cx9L5bJ3.js";import{S as j}from"./index-BXlQ47Wd.js";const p=x(`gap-xxs rounded font-medium box-border inline-flex cursor-pointer
  ...
  disabled:no-underline`,{variants:{intent:{primary:`bg-interactive-primary-default text-interactive-inverse
        ...
        hover:bg-interactive-neutral-alert-hover
        active:bg-interactive-neutral-alert-active
        active:text-interactive-alert-active`}],defaultVariants:{intent:"primary",size:"md"}}),g=x("",{variants:{ghost:{true:""},iconOnly:{true:""},size:{xs:"size-4",sm:"size-5",md:"size-5",lg:"size-6",xl:"size-7"}},defaultVariants:{size:"md"}}),y=z.forwardRef(({intent:a,size:i,className:c,icon:t,asChild:h=!1,loading:f=!1,danger:o=!1,children:r,...n},d)=>{const v=h?j:"button",l=!!(t&&!r),u=!!(r&&!t),m=f||n.disabled;if(f)return e.jsxs(v,{ref:d,className:s(p({intent:a,size:i,iconOnly:l,textOnly:u,danger:o}),"relative",c),...n,disabled:m,children:[e.jsxs("span",{className:"gap-xxs invisible flex items-center",children:[t&&(()=>{const b=t;return e.jsx(b,{className:s(g({size:i,iconOnly:l,ghost:a==="ghost"}))})})(),r]}),e.jsx("span",{className:"inset-0 absolute flex items-center justify-center",children:e.jsx(O,{size:"sm",layout:"row"})})]});if(t){const b=t;return e.jsxs(v,{ref:d,className:s(p({intent:a,size:i,iconOnly:l,textOnly:u,danger:o}),c),...n,disabled:m,children:[e.jsx(b,{className:s(g({size:i,iconOnly:l,ghost:a==="ghost"}))}),r]})}return e.jsx(v,{ref:d,className:s(p({intent:a,size:i,textOnly:u,danger:o}),c),children:r,...n,disabled:m})});y.displayName="Button";y.__docgenInfo={description:"",methods:[],displayName:"Button",props:{asChild:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},icon:{required:!1,tsType:{name:"union",raw:"TablerIcon | React.ComponentType<{ className: string }>",elements:[{name:"TablerIcon"},{name:"ReactComponentType",raw:"React.ComponentType<{ className: string }>",elements:[{name:"signature",type:"object",raw:"{ className: string }",signature:{properties:[{key:"className",value:{name:"string",required:!0}}]}}]}]},description:""},loading:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},danger:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}},composes:["VariantProps"]};export{y as B};
