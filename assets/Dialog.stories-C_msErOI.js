import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{e as _,r as b}from"./iframe-D8qJuWI3.js";import{B as h}from"./Button-Cjm_rGBA.js";import{R as E,P as V,O as z,C as W,T as F,a as Y}from"./index-DXwgWuQh.js";import"./preload-helper-Dp1pzeXC.js";import"./index-lnYcL0kX.js";import"./utils-CCJlgNnB.js";import"./ProgressIndicator-UYIUif7N.js";import"./index-CinCMbhD.js";import"./index-DrEC1Ud8.js";import"./index-C-TfqteI.js";import"./index-BCowv-3P.js";import"./index-asFILy3u.js";import"./index-Yaqrvp-q.js";import"./index-TqAw00zB.js";import"./index-BKtjU641.js";import"./index-DAzkriwG.js";import"./index-yX2YSHUy.js";const $=[{label:"Confirm",value:!0,intent:"primary"}],x=({isOpen:o,onClose:s,title:a,children:c,busy:p,actions:d=$,cancellable:n=!0,cancelButtonLabel:q="キャンセル"})=>{const[v,f]=_.useState(-1),O=p!==void 0?p:v!==-1,M=async t=>{const m=d.indexOf(t);if(t.onAction){f(m);const y=await t.onAction(s);if(f(-1),y===!1)return}else f(-1);o&&s(t.value)},L=()=>{s()};return e.jsx(E,{open:o,onOpenChange:s,children:e.jsx(V,{children:e.jsx(z,{className:`bg-surface-scrimmed top-0 left-0 z-dialog fixed h-full
            w-full`,children:e.jsxs(W,{"aria-describedby":void 0,onPointerDownOutside:t=>{(!n||O)&&t.preventDefault()},className:`bg-surface-primary rounded-lg z-dialog max-w-screen-sm
