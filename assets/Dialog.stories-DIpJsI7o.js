import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{e as z,r as v}from"./iframe-Cxjw105k.js";import{B as O}from"./Button-DhYPf4WN.js";import{R as K,P as $,O as G,C as Q,T as X}from"./index-C35qhqZy.js";import"./preload-helper-Dp1pzeXC.js";import"./index-k9WYd8WA.js";import"./utils-CVIV5-Af.js";import"./ProgressIndicator-BQLC4B6Y.js";import"./index-G4DTCjnz.js";import"./index-BnLlq7q7.js";import"./index-C6guuOpy.js";import"./index-BP6JuWat.js";import"./index-BDX0rAVp.js";import"./index-D0WLVuD3.js";import"./index-ZMdFGKjT.js";import"./index-9jvgRV6e.js";import"./index-B7FfZ6WV.js";import"./index-DsS-Awd-.js";const Z=[{label:"Confirm",value:!0,intent:"primary"}],x=({isOpen:a,onClose:t,onCancel:n=p=>p(),title:l,children:u,busy:r,actions:i=Z,cancellable:d=!0,cancelButtonLabel:b="キャンセル",allowClickOutside:o=!0})=>{const[p,w]=z.useState(-1),S=r!==void 0?r:p!==-1,_=async s=>{const y=i.indexOf(s);if(s.onAction){w(y);const k=await s.onAction(t);if(w(-1),k===!1)return}else w(-1);a&&t(s.value)},V=()=>{n(t)},W=s=>{s.preventDefault(),d&&!S&&o&&n(t)},F=s=>{if(S){s.preventDefault();return}s.preventDefault(),n(t)};return e.jsx(K,{open:a,onOpenChange:t,children:e.jsx($,{children:e.jsx(G,{className:`bg-surface-scrimmed top-0 left-0 z-dialog fixed h-full
