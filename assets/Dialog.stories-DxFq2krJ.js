import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{e as z,r as v}from"./iframe-t5mGpVjy.js";import{B as O}from"./Button-Dw2TCepN.js";import{R as K,P as $,O as G,C as Q,T as X}from"./index-bbuxyH7R.js";import"./preload-helper-Dp1pzeXC.js";import"./index-Rpdg_DnQ.js";import"./utils-x9NYt60w.js";import"./ProgressIndicator-Buf12cw2.js";import"./index-B9ZKJGSb.js";import"./index-Dox5C5cl.js";import"./index-NfTDOgzu.js";import"./index-6BO1NE2c.js";import"./index-Ck-aomId.js";import"./index-jqvFVNbf.js";import"./index-CPb_nvUo.js";import"./index-D62G9s8p.js";import"./index-DwRL6D9H.js";import"./index-CFQIT1ex.js";const Z=[{label:"Confirm",value:!0,intent:"primary"}],x=({isOpen:a,onClose:t,onCancel:n=p=>p(),title:l,children:u,busy:r,actions:i=Z,cancellable:d=!0,cancelButtonLabel:b="キャンセル",allowClickOutside:o=!0})=>{const[p,w]=z.useState(-1),S=r!==void 0?r:p!==-1,_=async s=>{const y=i.indexOf(s);if(s.onAction){w(y);const k=await s.onAction(t);if(w(-1),k===!1)return}else w(-1);a&&t(s.value)},V=()=>{n(t)},W=s=>{s.preventDefault(),d&&!S&&o&&n(t)},F=s=>{if(S){s.preventDefault();return}s.preventDefault(),n(t)};return e.jsx(K,{open:a,onOpenChange:t,children:e.jsx($,{children:e.jsx(G,{className:`bg-surface-scrimmed top-0 left-0 z-dialog fixed h-full
