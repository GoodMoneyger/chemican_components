import{j as e,r as _}from"./iframe-dis3juMU.js";import{C as b,a as t}from"./Checkbox-CaFRiMvd.js";import"./preload-helper-Dp1pzeXC.js";import"./IconMinus-CZ-qTUDy.js";import"./createReactComponent-CpcraBU9.js";import"./IconCheck-BInjca1P.js";import"./index-B_xNBDer.js";const P={title:"Components/Checkbox",component:b,parameters:{radixDocs:{primitive:"Checkbox",url:"https://www.radix-ui.com/primitives/docs/components/checkbox"}}},x=s=>e.jsxs(b,{children:[e.jsx(t,{...s,label:"Checkbox 1"}),e.jsx(t,{...s,label:"Checkbox 2"}),e.jsx(t,{...s,label:"Checkbox 3"})]}),O=()=>e.jsxs(b,{children:[e.jsx(t,{label:"Unchecked"}),e.jsx(t,{label:"Checked",checked:!0}),e.jsx(t,{label:"Indeterminate",indeterminate:!0}),e.jsx(t,{label:"Disabled Unchecked",disabled:!0}),e.jsx(t,{label:"Disabled Checked",disabled:!0,checked:!0}),e.jsx(t,{label:"Disabled Indeterminate",disabled:!0,indeterminate:!0})]}),c=x.bind({});c.args={invalid:!1,disabled:!1};const d=O.bind({}),a=x.bind({});a.args={invalid:!0,disabled:!1};const r=x.bind({});r.args={invalid:!1,disabled:!0};const R=()=>{const[s,o]=_.useState([]),n=["Item 1","Item 2","Item 3","Item 4"],U=l=>{o(l===!0?n:[])},w=(l,h)=>{o(h===!0?m=>[...m,l]:m=>m.filter(z=>z!==l))},p=s.length===n.length,E=s.length===0,N=!p&&!E;return e.jsxs(b,{children:[e.jsx(t,{label:"Select All",checked:p,indeterminate:N,onCheckedChange:U}),e.jsx("div",{style:{marginLeft:"24px",borderLeft:"1px solid #e2e8f0",paddingLeft:"16px"},children:n.map(l=>e.jsx(t,{label:l,checked:s.includes(l),onCheckedChange:h=>w(l,h)},l))}),e.jsxs("div",{style:{marginTop:"16px",fontSize:"14px",color:"#6b7280"},children:["Selected: ",s.length," of ",n.length," items"]})]})},i=R.bind({});var k,C,u;c.parameters={...c.parameters,docs:{...(k=c.parameters)==null?void 0:k.docs,source:{originalSource:`args => <CheckboxGroup>
...
}`,...(T=(y=i.parameters)==null?void 0:y.docs)==null?void 0:T.source}}};const Q=["Default","States","Invalid","Disabled","SelectAll"];export{c as Default,r as Disabled,a as Invalid,i as SelectAll,d as States,Q as __namedExportsOrder,P as default};
