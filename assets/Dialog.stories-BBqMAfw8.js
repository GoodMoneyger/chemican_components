import{e as ne,j as e,c as oe,r as p}from"./iframe-D3AB6Ne7.js";import{B as y}from"./Button-DlZH3ogN.js";import{T as ae}from"./index-E5d7Fnbm.js";import{R as ie,P as le,O as re,C as ue,T as ce}from"./index-S4FlQD85.js";import"./preload-helper-Dp1pzeXC.js";import"./ProgressIndicator-Be5YalIi.js";import"./TextField-DKKxuLnj.js";import"./useCompositionGuard-B_XjmcGy.js";import"./Popover-DVWY78ia.js";import"./index-DA1-Inoy.js";import"./index-CB5UPYQ0.js";import"./createReactComponent-C5k6TuXX.js";import"./Tag-BClCWgPh.js";import"./tokens-ClON5slf.js";const de=[{label:"Confirm",value:!0,intent:"primary"}],O=({isOpen:o,onClose:t,onCancel:n=b=>b(),title:a,children:l,busy:r,actions:u=de,cancellable:m=!0,cancelButtonLabel:w="キャンセル",allowClickOutside:i=!0,onOpenAutoFocus:T,bodyClassName:$})=>{const[b,S]=ne.useState(-1),j=r!==void 0?r:b!==-1,G=async s=>{const q=u.indexOf(s);if(s.onAction){S(q);const D=await s.onAction(t);if(S(-1),D===!1)return}else S(-1);o&&t(s.value)},X=()=>{n(t)},Z=s=>{s.preventDefault(),m&&!j&&i&&n(t)},ee=s=>{if(j){s.preventDefault();return}s.preventDefault(),n(t)};return e.jsx(ie,{open:o,onOpenChange:t,children:e.jsx(le,{children:e.jsx(re,{className:`bg-surface-scrimmed top-0 left-0 z-dialog fixed h-full
            w-full`,children:e.jsxs(ue,{"aria-describedby":void 0,onPointerDownOutside:Z,onEscapeKeyDown:ee,onOpenAutoFocus:T,className:`bg-surface-primary rounded-lg z-dialog max-w-screen-sm
              min-w-96 fixed top-1/2 left-1/2 w-2/3 -translate-x-1/2
              -translate-y-1/2 transform`,children:[e.jsx("header",{className:"px-xl py-lg",children:a&&e.jsx(ce,{className:`text-xxl text-body-primary font-bold flex
                    items-center leading-[1.2]`,children:a})}),e.jsx("div",{className:oe(`border-divider-default bg-surface-secondary px-xl pt-md pb-xxl
                text-body-primary max-h-[calc(100vh-40px-68px-78px)]
                overflow-hidden overflow-y-auto border-y-1`,$),children:l}),e.jsxs("footer",{className:"px-xl py-md flex justify-between",children:[m&&e.jsx(y,{intent:"tertiary",onClick:X,disabled:j,children:w}),e.jsx("div",{className:`gap-xs flex ${m?"":"ml-auto"}`,children:u.map((s,q)=>{const{label:D,classNames:se,onAction:me,value:ge,...te}=s;return e.jsx(y,{loading:b===q,...te,intent:s.intent||"primary",className:se,onClick:()=>G(s),children:D},q)})})]})]})})})})};O.__docgenInfo={description:"",methods:[],displayName:"Dialog",props:{isOpen:{required:!0,tsType:{name:"boolean"},description:""},onClose:{required:!0,tsType:{name:"signature",type:"function",raw:"(value?: unknown) => void",signature:{arguments:[{type:{name:"unknown"},name:"value"}],return:{name:"void"}}},description:""},onCancel:{required:!1,tsType:{name:"signature",type:"function",raw:"(close: () => void) => void | Promise<void>",signature:{arguments:[{type:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},name:"close"}],return:{name:"union",raw:"void | Promise<void>",elements:[{name:"void"},{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}]}}},description:"",defaultValue:{value:"(close) => close()",computed:!1}},children:{required:!0,tsType:{name:"ReactNode"},description:""},busy:{required:!1,tsType:{name:"boolean"},description:""},title:{required:!0,tsType:{name:"ReactNode"},description:""},actions:{required:!1,tsType:{name:"Array",elements:[{name:"DialogAction"}],raw:"DialogAction[]"},description:"",defaultValue:{value:`[
  {
    label: 'Confirm',
    value: true,
    intent: 'primary',
...
}`,...(Q=(K=d.parameters)==null?void 0:K.docs)==null?void 0:Q.source}}};const Ne=["Default","MultipleActions","NonCancellable","WithCustomActions","LongContent","WithOnCancelControl","WithPreventedAutoFocus"];export{g as Default,x as LongContent,h as MultipleActions,f as NonCancellable,v as WithCustomActions,c as WithOnCancelControl,d as WithPreventedAutoFocus,Ne as __namedExportsOrder,ke as default};
