import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{e as m}from"./iframe-evp4v1qV.js";import{S as g}from"./StatusIndicator-CWFPsj2J.js";import{a as h}from"./Checkbox-DbItMC8K.js";import{T as x}from"./Tag-DcwtQmVK.js";import{B as C}from"./Button-B0gPCUsW.js";import{c as f}from"./utils-DNMWgjTw.js";import{P as $}from"./ProgressIndicator-fNuO2i7O.js";import{I as O}from"./IconExternalLink-I1udX6Ml.js";import{I as W}from"./IconFileCheck-CAOo4E8A.js";import"./preload-helper-Dp1pzeXC.js";import"./index-B-IGPsXC.js";import"./IconMinus-BugbA367.js";import"./createReactComponent-C0hoS6_6.js";import"./IconCheck-CewZmukx.js";import"./index-Bnwr7FAb.js";import"./index-C7uyLT1w.js";import"./index-Db46fPhg.js";import"./index-CZ-STUBE.js";import"./index-DGp50Tuz.js";import"./index-oJ_aP8j8.js";import"./index-5WmFNliw.js";import"./index-BV16UHwP.js";import"./tokens-ClON5slf.js";const w={loading:!1,loadingText:"ローディング中…"},X=m.createContext(w),Y=()=>m.useContext(X),v=m.forwardRef(({className:r,children:i,loading:a=w.loading,loadingText:c=w.loadingText,...o},n)=>{const s={loading:a,loadingText:c};return e.jsx(X.Provider,{value:s,children:e.jsx("table",{ref:n,className:f(`border-surface-default bg-surface-primary relative caption-bottom
      ...
      text-left leading-[1.2] [&:has([role=checkbox])]:max-w-none`,r),...a,children:e.jsx("div",{className:"gap-xxs flex items-center",children:i})}));t.displayName="TableHead";const l=m.forwardRef(({className:r,...i},a)=>e.jsx("td",{ref:a,className:f(`py-sm [&:has([role=checkbox])]:pl-xl [&:has([role=checkbox])]:pr-0 px-md
...
}`,...(F=(V=y.parameters)==null?void 0:V.docs)==null?void 0:F.source}}};const ye=["Default","Loading","WithCoverMessage","WithRowOverlay"];export{S as Default,H as Loading,N as WithCoverMessage,y as WithRowOverlay,ye as __namedExportsOrder,Ne as default};
