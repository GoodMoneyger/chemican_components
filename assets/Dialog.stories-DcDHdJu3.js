import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{e as z,r as v}from"./iframe-DJDsIfOY.js";import{B as O}from"./Button-BA_gv45L.js";import{R as K,P as $,O as G,C as Q,T as X}from"./index-DNjlkcBi.js";import"./preload-helper-Dp1pzeXC.js";import"./index-CJ8UfGAI.js";import"./utils-CyrNgu0g.js";import"./ProgressIndicator-Cg1FA92U.js";import"./index-Ch-_b7Bl.js";import"./index-DBSIHet4.js";import"./index-xr8xRIcE.js";import"./index-BHiYjweo.js";import"./index-B-68s6i5.js";import"./index-B68iF3l7.js";import"./index-DxJBAqbu.js";import"./index-RygZPiqv.js";import"./index-95ABbGGL.js";import"./index-CiyE8-b6.js";const Z=[{label:"Confirm",value:!0,intent:"primary"}],x=({isOpen:a,onClose:t,onCancel:n=p=>p(),title:l,children:u,busy:r,actions:i=Z,cancellable:d=!0,cancelButtonLabel:b="キャンセル",allowClickOutside:o=!0})=>{const[p,w]=z.useState(-1),S=r!==void 0?r:p!==-1,_=async s=>{const y=i.indexOf(s);if(s.onAction){w(y);const k=await s.onAction(t);if(w(-1),k===!1)return}else w(-1);a&&t(s.value)},V=()=>{n(t)},W=s=>{s.preventDefault(),d&&!S&&o&&n(t)},F=s=>{if(S){s.preventDefault();return}s.preventDefault(),n(t)};return e.jsx(K,{open:a,onOpenChange:t,children:e.jsx($,{children:e.jsx(G,{className:`bg-surface-scrimmed top-0 left-0 z-dialog fixed h-full
