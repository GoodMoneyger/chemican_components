import{e as ne,j as e,c as oe,r as p}from"./iframe-dis3juMU.js";import{B as y}from"./Button-Duuzt55-.js";import{T as ae}from"./index-OJB2V5py.js";import{R as ie,P as le,O as re,C as ue,T as ce}from"./index-BLtlLXnC.js";import"./preload-helper-Dp1pzeXC.js";import"./ProgressIndicator-C7S5GtHe.js";import"./TextField-Ce1NX5dA.js";import"./useCompositionGuard-YzcpEsiN.js";import"./Popover-Cgxw_RED.js";import"./index-6UFxpeeI.js";import"./index-DPqzBPrk.js";import"./createReactComponent-CpcraBU9.js";import"./Tag-L6slzSa8.js";import"./tokens-ClON5slf.js";const de=[{label:"Confirm",value:!0,intent:"primary"}],O=({isOpen:o,onClose:t,onCancel:n=b=>b(),title:a,children:l,busy:r,actions:u=de,cancellable:m=!0,cancelButtonLabel:w="キャンセル",allowClickOutside:i=!0,onOpenAutoFocus:T,bodyClassName:$})=>{const[b,S]=ne.useState(-1),j=r!==void 0?r:b!==-1,G=async s=>{const q=u.indexOf(s);if(s.onAction){S(q);const D=await s.onAction(t);if(S(-1),D===!1)return}else S(-1);o&&t(s.value)},X=()=>{n(t)},Z=s=>{s.preventDefault(),m&&!j&&i&&n(t)},ee=s=>{if(j){s.preventDefault();return}s.preventDefault(),n(t)};return e.jsx(ie,{open:o,onOpenChange:t,children:e.jsx(le,{children:e.jsx(re,{className:`bg-surface-scrimmed top-0 left-0 z-dialog fixed h-full
