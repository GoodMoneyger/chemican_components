import{e as te,j as e,r as p}from"./iframe-Bvo2Mu9u.js";import{B as y}from"./Button-Di8Ga0P6.js";import{T as ne}from"./index-CdRJbuqK.js";import{R as oe,P as ae,O as ie,C as le,T as re}from"./index-BUQH0KE7.js";import"./preload-helper-Dp1pzeXC.js";import"./ProgressIndicator-DdK4SFwJ.js";import"./TextField-BhIr4ztT.js";import"./Popover-BLSSDKNu.js";import"./index-76vl0oRP.js";import"./index-BGtdJyAd.js";import"./createReactComponent-B1miNp5l.js";import"./Tag-B-JRqmuc.js";import"./tokens-ClON5slf.js";const ue=[{label:"Confirm",value:!0,intent:"primary"}],O=({isOpen:o,onClose:t,onCancel:n=b=>b(),title:a,children:l,busy:r,actions:u=ue,cancellable:m=!0,cancelButtonLabel:q="キャンセル",allowClickOutside:i=!0,onOpenAutoFocus:T})=>{const[b,S]=te.useState(-1),j=r!==void 0?r:b!==-1,$=async s=>{const w=u.indexOf(s);if(s.onAction){S(w);const D=await s.onAction(t);if(S(-1),D===!1)return}else S(-1);o&&t(s.value)},G=()=>{n(t)},X=s=>{s.preventDefault(),m&&!j&&i&&n(t)},Z=s=>{if(j){s.preventDefault();return}s.preventDefault(),n(t)};return e.jsx(oe,{open:o,onOpenChange:t,children:e.jsx(ae,{children:e.jsx(ie,{className:`bg-surface-scrimmed top-0 left-0 z-dialog fixed h-full
