...
}`,...(O=(M=g.parameters)==null?void 0:M.docs)==null?void 0:O.source}}};var E,j,T;P.parameters={...P.parameters,docs:{...(E=P.parameters)==null?void 0:E.docs,source:{originalSource:`args => {
  const [currentPage, setCurrentPage] = useState(args.currentPage);
  const [rowsPerPage, setRowsPerPage] = useState(args.rowsPerPage);
...
}`,...(X=(U=m.parameters)==null?void 0:U.docs)==null?void 0:X.source}}};const Je=["Default","FirstPage","MiddlePage","LastPage","SmallDataset","SinglePage","WithoutNavigation","EnglishLabels"];export{g as Default,m as EnglishLabels,P as FirstPage,i as LastPage,c as MiddlePage,u as SinglePage,l as SmallDataset,p as WithoutNavigation,Je as __namedExportsOrder,Ge as default};
