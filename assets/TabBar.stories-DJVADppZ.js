import{j as a}from"./jsx-runtime-D_zvdyIk.js";import{r as v,e as P}from"./iframe-Cg4IhQ5V.js";import{c as E}from"./index-Y-PzpK24.js";import{c as S}from"./utils-D1Xj6ROm.js";import{u as H,c as j}from"./index-Rtm3wYpT.js";import{c as J,P as z}from"./index-G9im3NaA.js";import{c as D,R as Q,I as U}from"./index-DnpF6Yn8.js";import{P as W}from"./index-DscaWDZy.js";import{u as X}from"./index-Cr1DoJ1v.js";import{u as Y}from"./index-CwNQ2ktU.js";import"./preload-helper-Dp1pzeXC.js";import"./index-Dm1p3zII.js";import"./index-Cn6gezY5.js";import"./index-ZtdV4tq7.js";import"./index-Bn3ZiLR6.js";import"./index-DPa9gN6g.js";var g="Tabs",[Z]=J(g,[D]),M=D(),[aa,N]=Z(g),F=v.forwardRef((e,l)=>{const{__scopeTabs:o,value:s,onValueChange:r,defaultValue:b,orientation:i="horizontal",dir:c,activationMode:p="automatic",...x}=e,d=X(c),[n,m]=H({prop:s,onChange:r,defaultProp:b??"",caller:g});return a.jsx(aa,{scope:o,baseId:Y(),value:n,onValueChange:m,orientation:i,dir:d,activationMode:p,children:a.jsx(z.div,{dir:d,"data-orientation":i,...x,ref:l})})});F.displayName=g;var G="TabsList",k=v.forwardRef((e,l)=>{const{__scopeTabs:o,loop:s=!0,...r}=e,b=N(G,o),i=M(o);return a.jsx(Q,{asChild:!0,...i,orientation:b.orientation,dir:b.dir,loop:s,children:a.jsx(z.div,{role:"tablist","aria-orientation":b.orientation,...r,ref:l})})});k.displayName=G;var L="TabsTrigger",$=v.forwardRef((e,l)=>{const{__scopeTabs:o,value:s,disabled:r=!1,...b}=e,i=N(L,o),c=M(o),p=q(i.baseId,s),x=O(i.baseId,s),d=s===i.value;return a.jsx(U,{asChild:!0,...c,focusable:!r,active:d,children:a.jsx(z.button,{type:"button",role:"tab","aria-selected":d,"aria-controls":x,"data-state":d?"active":"inactive","data-disabled":r?"":void 0,disabled:r,id:p,...b,ref:l,onMouseDown:j(e.onMouseDown,n=>{!r&&n.button===0&&n.ctrlKey===!1?i.onValueChange(s):n.preventDefault()}),onKeyDown:j(e.onKeyDown,n=>{[" ","Enter"].includes(n.key)&&i.onValueChange(s)}),onFocus:j(e.onFocus,()=>{const n=i.activationMode!=="manual";!d&&!r&&n&&i.onValueChange(s)})})})});$.displayName=L;var K="TabsContent",ea=v.forwardRef((e,l)=>{const{__scopeTabs:o,value:s,forceMount:r,children:b,...i}=e,c=N(K,o),p=q(c.baseId,s),x=O(c.baseId,s),d=s===c.value,n=v.useRef(d);return v.useEffect(()=>{const m=requestAnimationFrame(()=>n.current=!1);return()=>cancelAnimationFrame(m)},[]),a.jsx(W,{present:r||d,children:({present:m})=>a.jsx(z.div,{"data-state":d?"active":"inactive","data-orientation":c.orientation,role:"tabpanel","aria-labelledby":p,hidden:!m,id:x,tabIndex:0,...i,ref:l,style:{...e.style,animationDuration:n.current?"0s":void 0},children:m&&b})})});ea.displayName=K;function q(e,l){return`${e}-trigger-${l}`}function O(e,l){return`${e}-content-${l}`}var ta=F,sa=k,la=$;const ra=E("inline-flex",{variants:{size:{normal:"h-12",small:"h-10"}},defaultVariants:{size:"normal"}}),ia=E(`text-body-primary border-divider-default hover:border-interactive-hover
...
}`,...(V=(R=f.parameters)==null?void 0:R.docs)==null?void 0:V.source}}};var C,I,_;T.parameters={...T.parameters,docs:{...(C=T.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: {
    size: 'small'
  },
  render: args => <TabBar {...args}>
...
}`,...(_=(I=T.parameters)==null?void 0:I.docs)==null?void 0:_.source}}};var A,w,B;h.parameters={...h.parameters,docs:{...(A=h.parameters)==null?void 0:A.docs,source:{originalSource:`{
...
}`,...(B=(w=h.parameters)==null?void 0:w.docs)==null?void 0:B.source}}};const Na=["Default","Small","AllStates"];export{h as AllStates,f as Default,T as Small,Na as __namedExportsOrder,Sa as default};
