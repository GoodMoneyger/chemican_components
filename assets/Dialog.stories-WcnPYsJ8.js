import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{e as z,r as v}from"./iframe-CJyJig65.js";import{B as O}from"./Button-BvP93QCm.js";import{R as K,P as $,O as G,C as Q,T as X}from"./index-B5edirDj.js";import"./preload-helper-Dp1pzeXC.js";import"./index-CMCsz5oD.js";import"./utils-DpCO0Q1B.js";import"./ProgressIndicator-DnDBi_1p.js";import"./index-Ciep35Jl.js";import"./index-CuJTRqUJ.js";import"./index-BzXbhi96.js";import"./index-BaIisMVj.js";import"./index-DXjOSkOj.js";import"./index-CoAxmlPh.js";import"./index-CWhNEX9r.js";import"./index-CGuSN9gj.js";import"./index-bpNvUdI6.js";import"./index-Bi6yd1SO.js";const Z=[{label:"Confirm",value:!0,intent:"primary"}],x=({isOpen:a,onClose:t,onCancel:n=p=>p(),title:l,children:u,busy:r,actions:i=Z,cancellable:d=!0,cancelButtonLabel:b="キャンセル",allowClickOutside:o=!0})=>{const[p,w]=z.useState(-1),S=r!==void 0?r:p!==-1,_=async s=>{const y=i.indexOf(s);if(s.onAction){w(y);const k=await s.onAction(t);if(w(-1),k===!1)return}else w(-1);a&&t(s.value)},V=()=>{n(t)},W=s=>{s.preventDefault(),d&&!S&&o&&n(t)},F=s=>{if(S){s.preventDefault();return}s.preventDefault(),n(t)};return e.jsx(K,{open:a,onOpenChange:t,children:e.jsx($,{children:e.jsx(G,{className:`bg-surface-scrimmed top-0 left-0 z-dialog fixed h-full
