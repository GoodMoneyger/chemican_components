import{r as l,f as Z,u as re,j as e,d as ee,g as ie,s as oe,h as he,c as R}from"./iframe-BjW7qwuv.js";import{u as ue}from"./index-DDoLYd-M.js";import"./preload-helper-Dp1pzeXC.js";var N="Switch",[pe]=he(N),[me,fe]=pe(N),te=l.forwardRef((t,c)=>{const{__scopeSwitch:s,name:n,checked:a,defaultChecked:r,required:i,disabled:o,value:f="on",onCheckedChange:y,form:h,...E}=t,[w,v]=l.useState(null),M=Z(c,j=>v(j)),_=l.useRef(!1),D=w?h||!!w.closest("form"):!0,[S,ne]=re({prop:a,defaultProp:r??!1,onChange:y,caller:N});return e.jsxs(me,{scope:s,checked:S,disabled:o,children:[e.jsx(ee.button,{type:"button",role:"switch","aria-checked":S,"aria-required":i,"data-state":de(S),"data-disabled":o?"":void 0,disabled:o,value:f,...E,ref:M,onClick:ie(t.onClick,j=>{ne(le=>!le),D&&(_.current=j.isPropagationStopped(),_.current||j.stopPropagation())})}),D&&e.jsx(ce,{control:w,bubbles:!_.current,name:n,value:f,checked:S,required:i,disabled:o,form:h,style:{transform:"translateX(-100%)"}})]})});te.displayName=N;var se="SwitchThumb",ae=l.forwardRef((t,c)=>{const{__scopeSwitch:s,...n}=t,a=fe(se,s);return e.jsx(ee.span,{"data-state":de(a.checked),"data-disabled":a.disabled?"":void 0,...n,ref:c})});ae.displayName=se;var be="SwitchBubbleInput",ce=l.forwardRef(({__scopeSwitch:t,control:c,checked:s,bubbles:n=!0,...a},r)=>{const i=l.useRef(null),o=Z(i,r),f=ue(s),y=oe(c);return l.useEffect(()=>{const h=i.current;if(!h)return;const E=window.HTMLInputElement.prototype,v=Object.getOwnPropertyDescriptor(E,"checked").set;if(f!==s&&v){const M=new Event("click",{bubbles:n});v.call(h,s),h.dispatchEvent(M)}},[f,s,n]),e.jsx("input",{type:"checkbox","aria-hidden":!0,defaultChecked:s,...a,tabIndex:-1,ref:o,style:{...a.style,...y,position:"absolute",pointerEvents:"none",opacity:0,margin:0}})});ce.displayName=be;function de(t){return t?"checked":"unchecked"}var ke=te,Ce=ae;const d=l.forwardRef(({className:t,label:c,id:s,...n},a)=>{const r=s||(c?`switch-${c}`:void 0),i=e.jsx(ke,{ref:a,id:r,"data-slot":"switch",className:R(`peer data-[state=checked]:enabled:bg-status-success
