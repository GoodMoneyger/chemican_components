import{e as ne,j as e,c as oe,r as p}from"./iframe-BZ0kmOsS.js";import{B as y}from"./Button-D_10aB7p.js";import{T as ae}from"./index-BvGr-R0U.js";import{R as ie,P as le,O as re,C as ue,T as ce}from"./index-Bkaq27VJ.js";import"./preload-helper-Dp1pzeXC.js";import"./ProgressIndicator-D5itePVs.js";import"./TextField-DoKNc8cn.js";import"./Popover-Dlf4j6Qe.js";import"./index-ClH8mDfY.js";import"./index-C1crO2km.js";import"./createReactComponent-BL78-xNR.js";import"./Tag-DrZJ808Q.js";import"./tokens-ClON5slf.js";const de=[{label:"Confirm",value:!0,intent:"primary"}],O=({isOpen:o,onClose:t,onCancel:n=b=>b(),title:a,children:l,busy:r,actions:u=de,cancellable:m=!0,cancelButtonLabel:w="キャンセル",allowClickOutside:i=!0,onOpenAutoFocus:T,bodyClassName:$})=>{const[b,S]=ne.useState(-1),j=r!==void 0?r:b!==-1,G=async s=>{const q=u.indexOf(s);if(s.onAction){S(q);const D=await s.onAction(t);if(S(-1),D===!1)return}else S(-1);o&&t(s.value)},X=()=>{n(t)},Z=s=>{s.preventDefault(),m&&!j&&i&&n(t)},ee=s=>{if(j){s.preventDefault();return}s.preventDefault(),n(t)};return e.jsx(ie,{open:o,onOpenChange:t,children:e.jsx(le,{children:e.jsx(re,{className:`bg-surface-scrimmed top-0 left-0 z-dialog fixed h-full
...
}`,...(Q=(K=d.parameters)==null?void 0:K.docs)==null?void 0:Q.source}}};const ke=["Default","MultipleActions","NonCancellable","WithCustomActions","LongContent","WithOnCancelControl","WithPreventedAutoFocus"];export{g as Default,x as LongContent,h as MultipleActions,f as NonCancellable,v as WithCustomActions,c as WithOnCancelControl,d as WithPreventedAutoFocus,ke as __namedExportsOrder,Te as default};
