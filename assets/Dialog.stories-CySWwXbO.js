import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{e as z,r as v}from"./iframe-DfDuAT0-.js";import{B as O}from"./Button-QJhQWEfr.js";import{R as K,P as $,O as G,C as Q,T as X}from"./index-BPbQKBFW.js";import"./preload-helper-Dp1pzeXC.js";import"./index-BBfjfewq.js";import"./utils-B3fydF1S.js";import"./ProgressIndicator-Dznx547q.js";import"./index-D2DMfacZ.js";import"./index-dMQlMF5I.js";import"./index-DyO8QRks.js";import"./index-DZAflvvh.js";import"./index-B0uYOPGh.js";import"./index-CVRPaxfB.js";import"./index-CfBk7LPD.js";import"./index-DFZF5IYw.js";import"./index-DIlKACVr.js";import"./index-CYm_qTBd.js";const Z=[{label:"Confirm",value:!0,intent:"primary"}],x=({isOpen:a,onClose:t,onCancel:n=p=>p(),title:l,children:u,busy:r,actions:i=Z,cancellable:d=!0,cancelButtonLabel:b="キャンセル",allowClickOutside:o=!0})=>{const[p,w]=z.useState(-1),S=r!==void 0?r:p!==-1,_=async s=>{const y=i.indexOf(s);if(s.onAction){w(y);const k=await s.onAction(t);if(w(-1),k===!1)return}else w(-1);a&&t(s.value)},V=()=>{n(t)},W=s=>{s.preventDefault(),d&&!S&&o&&n(t)},F=s=>{if(S){s.preventDefault();return}s.preventDefault(),n(t)};return e.jsx(K,{open:a,onOpenChange:t,children:e.jsx($,{children:e.jsx(G,{className:`bg-surface-scrimmed top-0 left-0 z-dialog fixed h-full
