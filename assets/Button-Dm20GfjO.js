import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{e as O}from"./iframe-Da75iilk.js";import{c as f}from"./index-D_S0qt5J.js";import{c as n}from"./utils-DX2EYigD.js";import{S as j}from"./Spinner-DE1HQft3.js";import{S as z}from"./index-Bf96kyep.js";const g=f(`gap-xxs rounded font-medium box-border inline-flex cursor-pointer
  ...
  disabled:no-underline`,{variants:{intent:{primary:`bg-interactive-primary-default text-interactive-inverse
        ...
        hover:bg-interactive-neutral-danger-hover
        active:bg-interactive-neutral-danger-active
        active:text-interactive-danger-active`}],defaultVariants:{intent:"primary",size:"md"}}),x=f("",{variants:{ghost:{true:""},iconOnly:{true:""},size:{xs:"size-4",sm:"size-5",md:"size-5",lg:"size-6"}},defaultVariants:{size:"md"}}),y=O.forwardRef(({intent:a,size:i,className:c,icon:t,asChild:h=!1,loading:p=!1,danger:o=!1,children:r,...s},d)=>{const v=h?z:"button",l=!!(t&&!r),u=!!(r&&!t),m=p||s.disabled;if(p)return e.jsxs(v,{ref:d,className:n(g({intent:a,size:i,iconOnly:l,textOnly:u,danger:o}),"relative",c),...s,disabled:m,children:[e.jsxs("span",{className:"gap-xxs invisible flex items-center",children:[t&&(()=>{const b=t;return e.jsx(b,{className:n(x({size:i,iconOnly:l,ghost:a==="ghost"}))})})(),r]}),e.jsx("span",{className:"inset-0 absolute flex items-center justify-center",children:e.jsx(j,{size:"sm",layout:"row"})})]});if(t){const b=t;return e.jsxs(v,{ref:d,className:n(g({intent:a,size:i,iconOnly:l,textOnly:u,danger:o}),c),...s,disabled:m,children:[e.jsx(b,{className:n(x({size:i,iconOnly:l,ghost:a==="ghost"}))}),r]})}return e.jsx(v,{ref:d,className:n(g({intent:a,size:i,textOnly:u,danger:o}),c),children:r,...s,disabled:m})});y.displayName="Button";y.__docgenInfo={description:"",methods:[],displayName:"Button",props:{asChild:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},icon:{required:!1,tsType:{name:"union",raw:"TablerIcon | React.ComponentType<{ className: string }>",elements:[{name:"TablerIcon"},{name:"ReactComponentType",raw:"React.ComponentType<{ className: string }>",elements:[{name:"signature",type:"object",raw:"{ className: string }",signature:{properties:[{key:"className",value:{name:"string",required:!0}}]}}]}]},description:""},loading:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},danger:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}},composes:["VariantProps"]};export{y as B};
