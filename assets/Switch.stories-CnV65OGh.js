import{r as l,f as Z,u as re,j as e,d as ee,g as oe,s as ie,h as he,c as R}from"./iframe-DeeiCrKS.js";import{u as ue}from"./index-DefrKEnW.js";import"./preload-helper-Dp1pzeXC.js";var N="Switch",[pe]=he(N),[me,fe]=pe(N),te=l.forwardRef((t,c)=>{const{__scopeSwitch:s,name:n,checked:a,defaultChecked:r,required:o,disabled:i,value:f="on",onCheckedChange:y,form:h,...E}=t,[w,v]=l.useState(null),M=Z(c,j=>v(j)),_=l.useRef(!1),D=w?h||!!w.closest("form"):!0,[S,ne]=re({prop:a,defaultProp:r??!1,onChange:y,caller:N});return e.jsxs(me,{scope:s,checked:S,disabled:i,children:[e.jsx(ee.button,{type:"button",role:"switch","aria-checked":S,"aria-required":o,"data-state":de(S),"data-disabled":i?"":void 0,disabled:i,value:f,...E,ref:M,onClick:oe(t.onClick,j=>{ne(le=>!le),D&&(_.current=j.isPropagationStopped(),_.current||j.stopPropagation())})}),D&&e.jsx(ce,{control:w,bubbles:!_.current,name:n,value:f,checked:S,required:o,disabled:i,form:h,style:{transform:"translateX(-100%)"}})]})});te.displayName=N;var se="SwitchThumb",ae=l.forwardRef((t,c)=>{const{__scopeSwitch:s,...n}=t,a=fe(se,s);return e.jsx(ee.span,{"data-state":de(a.checked),"data-disabled":a.disabled?"":void 0,...n,ref:c})});ae.displayName=se;var be="SwitchBubbleInput",ce=l.forwardRef(({__scopeSwitch:t,control:c,checked:s,bubbles:n=!0,...a},r)=>{const o=l.useRef(null),i=Z(o,r),f=ue(s),y=ie(c);return l.useEffect(()=>{const h=o.current;if(!h)return;const E=window.HTMLInputElement.prototype,v=Object.getOwnPropertyDescriptor(E,"checked").set;if(f!==s&&v){const M=new Event("click",{bubbles:n});v.call(h,s),h.dispatchEvent(M)}},[f,s,n]),e.jsx("input",{type:"checkbox","aria-hidden":!0,defaultChecked:s,...a,tabIndex:-1,ref:i,style:{...a.style,...y,position:"absolute",pointerEvents:"none",opacity:0,margin:0}})});ce.displayName=be;function de(t){return t?"checked":"unchecked"}var ke=te,Ce=ae;const d=l.forwardRef(({className:t,label:c,id:s,...n},a)=>{const r=s||(c?`switch-${c}`:void 0),o=e.jsx(ke,{ref:a,id:r,"data-slot":"switch",className:R(`peer data-[state=checked]:enabled:bg-status-success
...
}`,...(A=(O=b.parameters)==null?void 0:O.docs)==null?void 0:A.source}}};var W,P,T;u.parameters={...u.parameters,docs:{...(W=u.parameters)==null?void 0:W.docs,source:{originalSource:`args => {
  const [checked, setChecked] = useState(args.defaultChecked || false);
  return <Switch {...args} checked={checked} onCheckedChange={newChecked => {
    setChecked(newChecked);
    args.onCheckedChange?.(newChecked);
...
}`,...(Y=(V=m.parameters)==null?void 0:V.docs)==null?void 0:Y.source}}};const Se=["Default","WithLabel","Checked","Disabled","DisabledChecked","AllStates","ControlledExample"];export{p as AllStates,k as Checked,m as ControlledExample,b as Default,C as Disabled,g as DisabledChecked,u as WithLabel,Se as __namedExportsOrder,ve as default};
