import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{I as w}from"./Input-B99LyjCc.js";import"./iframe-CGQI118J.js";import{c as L}from"./utils-Bq9-yrtp.js";import"./index-Do-4oKP_.js";import"./preload-helper-Dp1pzeXC.js";const D=({label:o,children:F,className:M,name:v,error:c,description:d,optional:S})=>e.jsxs("div",{className:"flex flex-col",children:[o&&e.jsxs("label",{htmlFor:v,className:L(`text-body-secondary gap-1 pb-2 text-xs font-normal flex
            items-center leading-none`,M),children:[e.jsx("span",{children:o}),S&&e.jsx("span",{className:"text-body-secondary",children:"(任意)"})]}),F,c&&e.jsx("div",{className:"pt-1",children:e.jsx("p",{className:"text-body-alert text-xs font-normal leading-[1.5]",children:c})}),d&&e.jsx("div",{className:"pt-1",children:e.jsx("p",{className:"text-body-secondary text-xs font-normal leading-[1.5]",children:d})})]});D.__docgenInfo={description:"",methods:[],displayName:"FormField",props:{label:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},className:{required:!1,tsType:{name:"string"},description:""},name:{required:!0,tsType:{name:"string"},description:""},error:{required:!1,tsType:{name:"string"},description:""},description:{required:!1,tsType:{name:"string"},description:""},optional:{required:!1,tsType:{name:"boolean"},description:""}}};const B={title:"Components/FormField",component:D,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{label:{control:"text",description:"The label for the form field"},name:{control:"text",description:"The name attribute for the form field"},error:{control:"text",description:"Error message to display below the field"},description:{control:"text",description:"Description text to display below the field"},optional:{control:"boolean",description:"Whether to show the optional indicator"}}},r=({hasError:o=!1})=>e.jsx(w,{placeholder:"Placeholder",invalid:o,prefixIcon:void 0,trailingIcon:void 0,disabled:!1,onTrailingIconClick:()=>{}}),a={args:{label:"Label",name:"default-field",children:e.jsx(r,{})}},n={args:{label:"ラベル",name:"optional-field",optional:!0,children:e.jsx(r,{})}},t={args:{label:"ラベル",name:"description-field",description:"日中に連絡のつきやすい電話番号を記入します",children:e.jsx(r,{})}},s={args:{label:"ラベル",name:"error-field",error:"数字で入力してください。",children:e.jsx(r,{hasError:!0})}},i={args:{label:"ラベル",name:"error-description-field",optional:!0,error:"数字で入力してください。",description:"日中に連絡のつきやすい電話番号を記入します",children:e.jsx(r,{hasError:!0})}},l={args:{name:"no-label-field",error:"数字で入力してください。",description:"日中に連絡のつきやすい電話番号を記入します",children:e.jsx(r,{hasError:!0})}};var p,m,u;a.parameters={...a.parameters,docs:{...(p=a.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
    label: 'Label',
    name: 'default-field',
    children: <MockInput />
...
}`,...(q=(k=l.parameters)==null?void 0:k.docs)==null?void 0:q.source}}};const G=["Default","Optional","WithDescription","WithError","WithErrorAndDescription","WithoutLabel"];export{a as Default,n as Optional,t as WithDescription,s as WithError,i as WithErrorAndDescription,l as WithoutLabel,G as __namedExportsOrder,B as default};
