import{e as o,j as e,l as P}from"./iframe-CoTE8yOf.js";import{R as le,T as ie,P as oe,C as de}from"./index-ZciF2MIS.js";import{C as ce}from"./Calendar-82HUpp30.js";import{T as me}from"./TextField-9uHp64dE.js";import{I as pe}from"./IconCalendarEvent-DADNMjo7.js";import"./preload-helper-Dp1pzeXC.js";import"./index-BDMWm6ZL.js";import"./createReactComponent-atIa4xyV.js";const he="bg-surface-primary rounded-lg z-dropdown w-auto  max-w-none shadow-lg",u=t=>{if(!t)return null;if(t instanceof Date)return isNaN(t.getTime())?null:t;const s=new Date(t);return isNaN(s.getTime())?null:s},ue=t=>t.toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}),a=o.forwardRef(({value:t,onChange:s,defaultValue:d,minDate:D,maxDate:j,disabled:N=!1,error:L=!1,invalid:_=!1,icon:A,iconSize:K=14,placeholder:U,formatDate:B=ue,className:G,contentClassName:H,defaultOpen:Q=!1,open:p,onOpenChange:i,side:X="bottom",locale:Z="ja"},$)=>{const[ee,ae]=o.useState(()=>u(d||null)),[te,w]=o.useState(Q),k=t!==void 0,h=k?u(t):ee,n=p!==void 0?p:te,c=o.useMemo(()=>u(D||null),[D]),m=o.useMemo(()=>u(j||null),[j]),se=o.useMemo(()=>!c||!m?!0:c<=m,[c,m]),re=r=>{const g=r||null;k||ae(g),s==null||s(g),g&&(p===void 0&&w(!1),i==null||i(!1))},l=r=>{p===void 0&&w(r),i==null||i(r)},ne=r=>{switch(r.key){case"ArrowDown":case"ArrowUp":case"Enter":case" ":r.preventDefault(),n||l(!0);break;case"Escape":n&&(r.preventDefault(),l(!1));break}};return e.jsxs(le,{open:n,onOpenChange:l,children:[e.jsx(ie,{asChild:!0,children:e.jsx(me,{ref:$,type:"text",readOnly:!0,placeholder:U,value:h?B(h):"",disabled:N,invalid:L||_,trailingIcon:A||pe,trailingIconSize:K,onTrailingIconClick:()=>!N&&l(!n),className:P(n&&"ring-interactive-focused ring-4",G),onKeyDown:ne,onClick:()=>!N&&l(!n),"aria-expanded":n,"aria-haspopup":"dialog"})}),e.jsx(oe,{children:e.jsx(de,{className:P(he,H),sideOffset:4,align:"start",alignOffset:0,side:X,avoidCollisions:!1,collisionPadding:16,sticky:"always",onEscapeKeyDown:()=>l(!1),onPointerDownOutside:()=>l(!1),role:"dialog","aria-label":"Date picker calendar",children:e.jsx(ce,{value:h,onChange:re,...c&&{minDate:c},...m&&{maxDate:m},disabled:!se,showOutsideDays:!0,fixedWeeks:!0,defaultMonth:h||new Date,locale:Z})})})]})});a.displayName="DatePicker";a.__docgenInfo={description:"",methods:[],displayName:"DatePicker",props:{value:{required:!1,tsType:{name:"union",raw:"Date | string | null",elements:[{name:"Date"},{name:"string"},{name:"null"}]},description:"The selected date value. Can be a Date object, string, or null."},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(date: Date | null) => void",signature:{arguments:[{type:{name:"union",raw:"Date | null",elements:[{name:"Date"},{name:"null"}]},name:"date"}],return:{name:"void"}}},description:"Callback function called when the date selection changes."},defaultValue:{required:!1,tsType:{name:"union",raw:"Date | string | null",elements:[{name:"Date"},{name:"string"},{name:"null"}]},description:"The default date value for uncontrolled usage."},minDate:{required:!1,tsType:{name:"Date"},description:"The minimum selectable date."},maxDate:{required:!1,tsType:{name:"Date"},description:"The maximum selectable date."},disabled:{required:!1,tsType:{name:"boolean"},description:"Whether the date picker is disabled.",defaultValue:{value:"false",computed:!1}},error:{required:!1,tsType:{name:"boolean"},description:"Whether the date picker input is in an error state.",defaultValue:{value:"false",computed:!1}},invalid:{required:!1,tsType:{name:"boolean"},description:"Whether the date picker input is in an invalid state. Alias for `error`.",defaultValue:{value:"false",computed:!1}},icon:{required:!1,tsType:{name:"union",raw:"React.ReactNode | TablerIcon",elements:[{name:"ReactReactNode",raw:"React.ReactNode"},{name:"TablerIcon"}]},description:"Custom icon to display in the trigger button."},iconSize:{required:!1,tsType:{name:"number"},description:"Size of the trailing icon in pixels.",defaultValue:{value:"14",computed:!1}},placeholder:{required:!1,tsType:{name:"string"},description:"Placeholder text to display when no date is selected."},formatDate:{required:!1,tsType:{name:"signature",type:"function",raw:"(date: Date) => string",signature:{arguments:[{type:{name:"Date"},name:"date"}],return:{name:"string"}}},description:"Format function for displaying the selected date.",defaultValue:{value:`(date: Date): string => {
...
}`,...(W=(z=v.parameters)==null?void 0:z.docs)==null?void 0:W.source}}};const Pe=["Default","States","CustomFormatting","Locales","StringPlaceholders"];export{y as CustomFormatting,x as Default,b as Locales,f as States,v as StringPlaceholders,Pe as __namedExportsOrder,ke as default};
