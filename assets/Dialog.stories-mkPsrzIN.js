import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{e as se,r as d}from"./iframe-BE1d8Y6c.js";import{B as y}from"./Button-DKGW4qhu.js";import{T as ne}from"./index-BckJH8Cg.js";import{R as oe,P as ae,O as ie,C as le,T as re}from"./index-Bc2CPpKD.js";import"./preload-helper-Dp1pzeXC.js";import"./index-CVAz0kT6.js";import"./utils-3m8A6s2d.js";import"./ProgressIndicator-B2LygwXD.js";import"./index-C6wpZVtn.js";import"./index-BENkcGmH.js";import"./index-CNWGEQqY.js";import"./index-C_eIzwv5.js";import"./TextField-BigrsNqb.js";import"./Popover-C17EtfvW.js";import"./index-aBm6ZHJ4.js";import"./index-CkEoo8rb.js";import"./index-D5Y8Iye7.js";import"./index-FN49YMBv.js";import"./index-wl7AnTGZ.js";import"./index-BZu4SM1z.js";import"./index-CJU4UgjJ.js";import"./index-BddRziDf.js";import"./index-hJrxwlc9.js";import"./createReactComponent-aFH6c689.js";import"./Tag-C-JSfUuj.js";import"./tokens-ClON5slf.js";const ue=[{label:"Confirm",value:!0,intent:"primary"}],O=({isOpen:o,onClose:s,onCancel:n=b=>b(),title:a,children:l,busy:r,actions:u=ue,cancellable:m=!0,cancelButtonLabel:q="キャンセル",allowClickOutside:i=!0,onOpenAutoFocus:T})=>{const[b,S]=se.useState(-1),j=r!==void 0?r:b!==-1,$=async t=>{const w=u.indexOf(t);if(t.onAction){S(w);const D=await t.onAction(s);if(S(-1),D===!1)return}else S(-1);o&&s(t.value)},G=()=>{n(s)},X=t=>{t.preventDefault(),m&&!j&&i&&n(s)},Z=t=>{if(j){t.preventDefault();return}t.preventDefault(),n(s)};return e.jsx(oe,{open:o,onOpenChange:s,children:e.jsx(ae,{children:e.jsx(ie,{className:`bg-surface-scrimmed top-0 left-0 z-dialog fixed h-full
            w-full`,children:e.jsxs(le,{"aria-describedby":void 0,onPointerDownOutside:X,onEscapeKeyDown:Z,onOpenAutoFocus:T,className:`bg-surface-primary rounded-lg z-dialog max-w-screen-sm
              ...
              -translate-y-1/2 transform`,children:[e.jsx("header",{className:"px-xl py-lg",children:a&&e.jsx(re,{className:`text-xxl text-body-primary font-bold flex
                ...
                overflow-y-auto border-y-1`,children:l}),e.jsxs("footer",{className:"px-xl py-md flex flex-shrink-0 justify-between",children:[m&&e.jsx(y,{intent:"tertiary",onClick:G,disabled:j,children:q}),e.jsx("div",{className:`gap-xs flex ${m?"":"ml-auto"}`,children:u.map((t,w)=>{const{label:D,classNames:ee,onAction:pe,value:de,...te}=t;return e.jsx(y,{loading:b===w,...te,intent:t.intent||"primary",className:ee,onClick:()=>$(t),children:D},w)})})]})]})})})})};O.__docgenInfo={description:"",methods:[],displayName:"Dialog",props:{isOpen:{required:!0,tsType:{name:"boolean"},description:""},onClose:{required:!0,tsType:{name:"signature",type:"function",raw:"(value?: unknown) => void",signature:{arguments:[{type:{name:"unknown"},name:"value"}],return:{name:"void"}}},description:""},onCancel:{required:!1,tsType:{name:"signature",type:"function",raw:"(close: () => void) => void | Promise<void>",signature:{arguments:[{type:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},name:"close"}],return:{name:"union",raw:"void | Promise<void>",elements:[{name:"void"},{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}]}}},description:"",defaultValue:{value:"(close) => close()",computed:!1}},children:{required:!0,tsType:{name:"ReactNode"},description:""},busy:{required:!1,tsType:{name:"boolean"},description:""},title:{required:!0,tsType:{name:"ReactNode"},description:""},actions:{required:!1,tsType:{name:"Array",elements:[{name:"DialogAction"}],raw:"DialogAction[]"},description:"",defaultValue:{value:`[
  {
    label: 'Confirm',
    value: true,
    intent: 'primary',
...
}`,...(Y=(H=c.parameters)==null?void 0:H.docs)==null?void 0:Y.source}}};var z,K,Q;p.parameters={...p.parameters,docs:{...(z=p.parameters)==null?void 0:z.docs,source:{originalSource:`args => {
  const [isOpen, setIsOpen] = useState(args.isOpen);
  const handleClose = () => {
    setIsOpen(false);
  };
...
}`,...(Q=(K=p.parameters)==null?void 0:K.docs)==null?void 0:Q.source}}};const Ee=["Default","MultipleActions","NonCancellable","WithCustomActions","LongContent","WithOnCancelControl","WithPreventedAutoFocus"];export{g as Default,x as LongContent,h as MultipleActions,f as NonCancellable,v as WithCustomActions,c as WithOnCancelControl,p as WithPreventedAutoFocus,Ee as __namedExportsOrder,_e as default};
