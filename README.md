...
```sh
npm install --save @chemican/components@git+ssh://git@github.com:GoodMoneyger/chemican_components.git#release-1.11.0
```

> [!NOTE]
> `#release-1.11.0` points to a specific version. You should set versions manually to avoid breaking changes.
