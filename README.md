...
```sh
npm install --save @chemican/components@git+ssh://git@github.com:GoodMoneyger/chemican_components.git#release-1.0.0-23
```

> [!NOTE]
> `#release-1.0.0-23` points to a specific version. You should set versions manually to avoid breaking changes.
