...
export declare enum ColorBorderTokens {
    ...
    InteractivetobedeleteDanger = "--token-color-border-interactivetobedelete-danger",
    InteractivetobedeleteLight = "--token-color-border-interactivetobedelete-light",
    InteractivetobedeleteMuted = "--token-color-border-interactivetobedelete-muted",
